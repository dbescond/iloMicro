...
if ${time}==2010 {
	...
	recode P8 (1/15 21 22=1) (16 23 31/35=2) (36 41/43 51/54=3) (55/84 =4) (.=5) , gen(ilo_edu_aggregate)
}
...
* note that given the structure of the data the reason for not seeking the past week (USED IN THE UNEMPLOYMENT DEFINITION) is bunched together with not seeking past 4 weeks (NOT USED)
	gen ilo_olf_reason=.
		replace ilo_olf_reason=1 if	(inlist(P10_18,8,9,10) & ilo_lfs==3)					//Labour market
		replace ilo_olf_reason=2 if	(inlist(P10_18,14,15)  & ilo_lfs==3)				//Personal/Family-related
		replace ilo_olf_reason=3 if (inlist(P10_18,11,12,13,16)  & ilo_lfs==3)							//Does not need/want to work
		replace ilo_olf_reason=4 if (inlist(P10_18,17)  & ilo_lfs==3)						//Not elsewhere classified
