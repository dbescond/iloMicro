* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Serbia, 2014Q1
* DATASET USED: Serbia LFS 2014
* NOTES:
...
global source "LFS"
global time "2014Q1"
global inputFile "LFS_2014Q1_IND"
...
* Comment: 
	...
	gen ilo_wap=.
		replace ilo_wap=1 if ilo_age>=15 & ilo_age!=.                           //15+ population
...
* Comment: Original classification: NACE Rev.2 three digit level
*          Using Eurostat correspondences table between ISIC Rev.4 and NACE Rev.2: one to one at 2 digit level
*          Economic activity  at the last job. Keeping two and one digit level.
...
cd "$outpath"
		...
		drop to_drop to_drop_1 to_drop_2 year quarter ntip
