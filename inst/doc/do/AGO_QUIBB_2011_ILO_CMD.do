...
* DATASET USED: Angola - Inquérito de Indicadores Básicos de Bem-Estar (QUIBB)  - 2011
* NOTES:
* Authors: DPAU
...
* -------------------------------------------------------------------------------------------
	...
	* Detailed categories:
		gen ilo_job1_ste_icse93=.
			...
			replace ilo_job1_ste_icse93=4 if (d22==7 & ilo_lfs==1)                		// Members of producers’ cooperatives
