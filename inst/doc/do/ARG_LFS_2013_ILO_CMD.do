...
* DATASET USED: Argentina LFS 2014
* NOTES: 
* Files created: Standard variables on LFS Argentina
* Authors: Podjanin
...
global source "LFS"
global time "2013"
global inputFile "Individual_EAHU_13"
...
* Comment: National classification being used --> align it to ISIC Rev. 4
	...
	gen indu_code_prim=pp04b_caes if ilo_lfs==1 
	...
	* One digit level
		...
		* Primary activity
		...
		gen ilo_job1_eco_isic4=.
			replace ilo_job1_eco_isic4=1 if inlist(indu_code_prim,"01","0101","0102","0103")
			replace ilo_job1_eco_isic4=1 if inlist(indu_code_prim,"0104","0105","02","0200","03","0300")
			replace ilo_job1_eco_isic4=2 if inlist(indu_code_prim,"05","0500","06","0600","07")
			replace ilo_job1_eco_isic4=2 if inlist(indu_code_prim,"0700","08","0800","09","0900")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"10","1001","1002","1003","1009","11","1100")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"12","1200","13","1300","14","1400","15")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"1501","1502","16","1600","17","1700","18","1800")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"19","1901","1902","20")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"2001","2002","2009","21","2100","22","2201","2202")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"23","2301","2309","24","2400","25","2500","26","2601")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"2602","2603","2604","27","2701","2709","28","2800","29")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"2900","30","3001","3002","3003","3009")
			replace ilo_job1_eco_isic4=3 if inlist(indu_code_prim,"31","3100","32","3200","33","3300")
			replace ilo_job1_eco_isic4=4 if inlist(indu_code_prim,"35","3501","3502")
			replace ilo_job1_eco_isic4=5 if inlist(indu_code_prim,"36","3600","37","3700","38","3800","39","3900")
			replace ilo_job1_eco_isic4=6 if inlist(indu_code_prim,"40","4000")
			replace ilo_job1_eco_isic4=7 if inlist(indu_code_prim,"45","4501","4502","4503","4504")
			replace ilo_job1_eco_isic4=7 if inlist(indu_code_prim,"48","4801","4802","4803","4804","4805","4806")
			replace ilo_job1_eco_isic4=7 if inlist(indu_code_prim,"4807","4808","4809","4810","4811")
			replace ilo_job1_eco_isic4=8 if inlist(indu_code_prim,"49","4901","4902","4903","4904","4905","4909")
			replace ilo_job1_eco_isic4=8 if inlist(indu_code_prim,"50","5000","51","5100","52","5201")
			replace ilo_job1_eco_isic4=8 if inlist(indu_code_prim,"5202","53","5300")
			replace ilo_job1_eco_isic4=9 if inlist(indu_code_prim,"55","5500","56","5601","5602")
			replace ilo_job1_eco_isic4=10 if inlist(indu_code_prim,"58","5800","59","5900","60","6000")
			replace ilo_job1_eco_isic4=10 if inlist(indu_code_prim,"61","6100","62","6200","63","6300")
			replace ilo_job1_eco_isic4=11 if inlist(indu_code_prim,"64","6400","65","6500","66","6600")
			replace ilo_job1_eco_isic4=12 if inlist(indu_code_prim,"68","6800")
			replace ilo_job1_eco_isic4=13 if inlist(indu_code_prim,"69","6900","70","7000","71","7100")
			replace ilo_job1_eco_isic4=13 if inlist(indu_code_prim,"72","7200","73","7301","7302","74")
			replace ilo_job1_eco_isic4=13 if inlist(indu_code_prim,"7400","75","7500")
			replace ilo_job1_eco_isic4=14 if inlist(indu_code_prim,"77","7701","7702","78","7800","79","7900")
			replace ilo_job1_eco_isic4=14 if inlist(indu_code_prim,"80","8000","81","8101","8102","82","8200")
			replace ilo_job1_eco_isic4=15 if inlist(indu_code_prim,"83","8300","84","8401","8402","8403")
			replace ilo_job1_eco_isic4=16 if inlist(indu_code_prim,"85","8501","8509")
			replace ilo_job1_eco_isic4=17 if inlist(indu_code_prim,"86","8600","87","8700","88","8800")
			replace ilo_job1_eco_isic4=18 if inlist(indu_code_prim,"90","9000","91","9100","92","9200")
			replace ilo_job1_eco_isic4=18 if inlist(indu_code_prim,"93","9301","9302")
			replace ilo_job1_eco_isic4=19 if inlist(indu_code_prim,"94","9401","9402","9409","95","9501")
			replace ilo_job1_eco_isic4=19 if inlist(indu_code_prim,"9502","9503","96","9601","9602","9603","9609")
			replace ilo_job1_eco_isic4=20 if inlist(indu_code_prim,"97","9700","98","9800")
			replace ilo_job1_eco_isic4=21 if inlist(indu_code_prim,"99","9900")
	...
	gen ilo_job1_ocu_isco08_2digits=.
		...
		replace ilo_job1_ocu_isco08_2digits=21 if inlist(occ_code_prim,34111,34121,34131,34201,34311,34321,34331,35111,35131,35201,35311,36111,36311,60111,60131,60201,60311, ///
				...
				90111,90121,90201,90311,90331,91111,91131,91201,91311,91331,92111,92131,92201,92311,92331) | (inlist(occ_code_prim,42111,42131,42201,42311,43111,43201,43311) & ///
								(substr(indu_code_prim,1,2)=="71" | substr(indu_code_prim,1,2)=="72") )
		replace ilo_job1_ocu_isco08_2digits=22 if inlist(occ_code_prim,30111,30201,30311,40111,40131,40201,40311,40331,44111,44131,44201,44311,61111,61131,61201) | ///
				(inlist(occ_code_prim,42111,42131,42201,42311,43111,43201,43311) & substr(indu_code_prim,1,2)=="86")
		...
		replace ilo_job1_ocu_isco08_2digits=24 if inlist(occ_code_prim,10111,10201,10311,10331,20111,20201,20311,20331,31111,31131,31311,32111,32201,32311,32331,54111,54311) | ///
								(inlist(occ_code_prim,42111,42131,42201,42311,43111,43201,43311) & 	(substr(indu_code_prim,1,2)=="78" | substr(indu_code_prim,1,2)=="70") )
		...
		replace ilo_job1_ocu_isco08_2digits=72 if inlist(occ_code_prim,82113,82133,82203,82313,82333,90113,90123,90203,90313,90323,92113,92203,92313,92323) | (inlist(occ_code_prim,80113,80313) & inlist(substr(indu_code_prim,1,2),"25","28"))
		replace ilo_job1_ocu_isco08_2digits=73 if occ_code_prim==80112 | (inlist(occ_code_prim,80113,80313) & inlist(substr(indu_code_prim,1,2),"18","23"))
		replace ilo_job1_ocu_isco08_2digits=74 if inlist(occ_code_prim,82112,82312)
		replace ilo_job1_ocu_isco08_2digits=75 if inlist(occ_code_prim,44113,82123,8323) | (inlist(occ_code_prim,80113,80313) & inlist(substr(indu_code_prim,1,2),"10","12","13","14","15","16","26","31"))
		replace ilo_job1_ocu_isco08_2digits=79 if inlist(occ_code_prim,80113,80313) & inlist(substr(indu_code_prim,1,2),"17","19","20","22","24","27","29","30","38")
		replace ilo_job1_ocu_isco08_2digits=81 if inlist(occ_code_prim,56123,56323,56324,70123,70313,70323,70333) | (inlist(occ_code_prim,80123,80133,80323,80333) & ///
				(inlist(substr(indu_code_prim,1,2),"10","12","13","14","15","16","17") | inlist(substr(indu_code_prim,1,2),"18","19","20","22","23","24","25","31")) )
		replace ilo_job1_ocu_isco08_2digits=82 if inlist(occ_code_prim,80123,80133,80323,80333) & inlist(substr(indu_code_prim,1,2),"26","27","28")
		...
		replace ilo_job1_ocu_isco08_2digits=89 if inlist(occ_code_prim,80123,80133,80323,80333) & inlist(substr(indu_code_prim,1,2),"29","30","38")
...
* Comment: 
	...
	* Useful questions: pp04a and pp04b1: Institutional sector 
					...
					*	pp07h: Pension fund
					*	pp07g1: Paid annual leave
					*	pp07g3: Paid sick leave
	...
	* Social security coverage: person considered as having a social security coverage when:
	...
	gen soc_sec_cov=1 if pp07h==1 & pp07g1==1 & pp07g3==1

	gen ilo_job1_ife_prod=.
		replace ilo_job1_ife_prod=1 if pp04a!=1 & !inlist(pp06e,1,2) & ( (inlist(pp04g,1,2,4,10,99,0,.) & !inrange(pp04c,5,12) & soc_sec_cov!=1) | (inlist(pp04g,3,5,6,9) & soc_sec_cov!=1) )
		replace ilo_job1_ife_prod=2 if pp04a==1 | (pp04a!=1 & inlist(pp06e,1,2)) | (pp04a!=1 & !inlist(pp06e,1,2) & ((inlist(pp04g,1,2,4,10,99,0,.) & inrange(pp04c,5,12))| ///
								(inlist(pp04g,1,2,4,10,99,0,.) & !inrange(pp04c,5,12) & soc_sec_cov==1) | (inlist(pp04g,3,5,6,9) & soc_sec_cov==1) ) )
		replace ilo_job1_ife_prod=3 if pp04b1==1 | (pp04a!=1 & !inlist(pp06e,1,2) & inlist(pp04g,7,8)) | ilo_job1_ocu_isco08_2digits==63 
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			Earnings ('ilo_ear_ees' and 'ilo_ear_slf') [check with Yves]
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
	
* Comment: check whether to include "retroactivos (sueldos adeudados)"
	...
	* Primary employment 
		...
		egen ilo_job1_lri_ees=rowtotal(pp08d1 pp08d4 pp08f1 pp08f2 pp08j1 pp08j2 pp08j3), m
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			Time-related underemployed ('ilo_tru') [check - otherwise done]
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
...
* Comment: given that usual hours can't be defined, actual hours worked are being used
			* for the availability criterion: consider also if person is available immediately or latest in two weeks 
				* check with Yves whether it can be defined like this
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			Previous economic activity ('ilo_preveco_isic4') [check whether to include]
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			Previous occupation ('ilo_prevocu_isco08') [check whether to include]
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			
* Comment: 
...
cd "$outpath"
		...
		drop indu_code_* occ_code_* /* prev*_cod */ self_earn* lab isco08_2digits isco88_2digits isco08 isco88 isic4_2digits isic4 isic3_2digits isic3 
