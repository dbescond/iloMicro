...
* Comment: - Category "1 month to less than 3 months" includes category "less than 1 month".
	...
	gen ilo_dur_details=.
		...
		replace ilo_dur_details=3 if (z62==2 & ilo_lfs==2)                      // 3 months to less than 6 months
		replace ilo_dur_details=4 if (inlist(z62,3,4) & ilo_lfs==2)             // 6 months to less than 12 months
		replace ilo_dur_details=5 if (z62==5 & ilo_lfs==2)                      // 12 months to less than 24 months
		replace ilo_dur_details=6 if ((z62==6 | z62==7)  & ilo_lfs==2)          // 24 months or more
