* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Armenia, 2012
* DATASET USED: Armenia, SWTS, 2012
* NOTES: 
* Files created: Standard variables ARM_SWTS_2012_FULL.dta and ARM_SWTS_2012_ILO.dta
...
global source "SWTS"
global time "2012"
global inputFile "ARM_SWTS_2012.dta"
...
*
	...
	* Employees
	gen ilo_job1_lri_ees = .
		...
		replace ilo_job1_lri_ees = cash_amount *(5*52/12) if payment_period==1
		replace ilo_job1_lri_ees = cash_amount *(52/12) if payment_period==2
		replace ilo_job1_lri_ees = cash_amount *(26/12) if payment_period==3
...
* Comment:
	...
	gen ilo_dis=1 if (ilo_lfs==3 & availability==1 & ilo_olf_reason==1)
