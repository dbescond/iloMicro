...
global country "BEN" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2012"  /*time*/
global inputFile "BEN_SWTS_2012.dta" /*name of the input file in stata format*/
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: Missing one value in the questionaire on Pre-primary education. 
	...
	* Detailed
	gen ilo_edu_isced97=.
		...
		*replace ilo_edu_isced97=2 if  highestlevel_comp==// Pre-primary education
		...
		replace ilo_edu_isced97=6 if  highestlevel_comp==5      // Post-secondary non-tertiary education
		replace ilo_edu_isced97=7 if  highestlevel_comp==6       // First stage of tertiary education (not leading directly to an advanced research qualification)
		replace ilo_edu_isced97=8 if  highestlevel_comp==7       // Second stage of tertiary education (leading to an advanced research qualification)                               
...
* Comment: 
	...
	gen ilo_lfs=.
        replace ilo_lfs=1 if (c27a==1 | c27b==1 | c27c==1 | c27d==1 | ///
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: Apprentices (d07==6) have been classified with Employees. 

   * MAIN JOB:
   * ICSE 1993
	 gen ilo_job1_ste_icse93=.
		 replace ilo_job1_ste_icse93=1 if inlist(d07,1,6) & ilo_lfs==1          // Employees
		 replace ilo_job1_ste_icse93=2 if d07==2 & ilo_lfs==1          // Employers
		 replace ilo_job1_ste_icse93=3 if d07==3 & ilo_lfs==1          // Own-account workers
		 replace ilo_job1_ste_icse93=4 if d07==4 & ilo_lfs==1          // Members of producers' cooperatives
		 replace ilo_job1_ste_icse93=5 if d07==5 & ilo_lfs==1          // Contributing family workers
...
/* Useful questions:
		  ...
		  - Place of work:
		  - Size:
		  - Paid annual leave: d13d
		  - Paid sick leave:d13e
*/
    * Social Security:
	gen social_security=.
    ...
    * 1) UNIT OF PRODUCTION: FORMAL/INFORMAL SECTOR
	gen ilo_job1_ife_prod=.
		...
		replace ilo_job1_ife_prod=2 if ilo_lfs==1 & ilo_job1_ife_prod!=3 & ///
		                               (publicadmin==1 | ///
									   d05==1 | ///
									   (inlist(d05,4) & ilo_job1_ste_icse93==1 & social_security==1))
	...
	* 2) NATURE OF JOB: FORMAL/INFORMAL EMPLOYMENT
	gen ilo_job1_ife_nature=.
	    replace ilo_job1_ife_nature=2 if ilo_lfs==1 & ///
										 ...
										 (ilo_job1_ste_icse93==1 & d13d==1 & d13e==1) | ///
...
* Comment: 
	...
	* Employees
	gen ilo_job1_lri_ees = .
	    replace ilo_job1_lri_ees = d14x if ilo_job1_ste_aggregate==1
		replace ilo_job1_lri_ees = d14x *(5*52/12) if d18==1
		replace ilo_job1_lri_ees = d14x *(52/12) if d18==2
...
* Comment: 
		...
		gen ilo_olf_reason=.
			replace ilo_olf_reason=1 if inlist(e05,7,8,9,10,11,12)           & ilo_lfs==3             // Labour market 
			...
			replace ilo_olf_reason=5 if (inlist(e05,99) | ilo_olf_reason==.) & ilo_lfs==3     // Not elsewhere classified
