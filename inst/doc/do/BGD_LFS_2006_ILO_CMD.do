...
** There is no info on union/cohabiting. 
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if mst==1                                    // Single
		replace ilo_mrts_details=2 if mst==2                                    // Married
		*replace ilo_mrts_details=3 if                                          // Union / cohabiting
		replace ilo_mrts_details=4 if mst==3                                    // Widowed
		replace ilo_mrts_details=5 if inlist(mst,4,5)                           // Divorced / separated
