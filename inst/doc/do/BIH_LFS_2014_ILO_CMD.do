...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
*		            	Geographical coverage ('ilo_geo') 		               *------------------------------------- TO CHECK
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - find the variable referring to the geographical coverage.
	/*
	gen ilo_geo=.
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
*			           Level of education ('ilo_edu') 		                   *--------------------------------------- TO CHECK (mapping)
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - check: http://www.euroeducation.net/prof/boherco.htm
*            check: the questionnaire.
    ...
    * Detailed				
    gen ilo_edu_isced11=.
		replace ilo_edu_isced11=1 if diploma==1                       // No schooling
		replace ilo_edu_isced11=2 if diploma==2                       // Early childhood education
		replace ilo_edu_isced11=3 if                        // Primary education
		replace ilo_edu_isced11=4 if diploma==3                       // Lower secondary education
		replace ilo_edu_isced11=5 if diploma==4                       // Upper secondary education
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
*		  	 Educational attendance ('ilo_edu_attendance') 		               *------------------------------------- TO CHECK IF THERE'S INFO
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - to check: Given that original category 1 refers to unmarried/single,
*            category "union/cohabiting" is not defined. Original category illegitimate
*            marriage is left as "not elsewhere classified" (I couldn't find
*            information about the definition of illegitimate marriage in the bosnian 
*            context).
