* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Brazil
* DATASET USED: Brazil QLFS
* NOTES: 
* Files created: Standard variables on QLFS Brazil
	...
	* Hours usually worked
		...
		* Tertiary job
		...
		gen ilo_job3_how_usual=v4062
				replace ilo_job3_how_usual=. if  ilo_mjh!=2
		...
		* Secondary job 
		...
		gen ilo_job2_how_actual_bands=.
			...
			replace ilo_job2_how_actual_bands=8 if ilo_job2_how_actual_bands==. & ilo_lfs==1 & ilo_mjh==2
				replace ilo_job2_how_actual_bands=. if ilo_lfs!=1 & ilo_mjh!=2
...
* Comment: 
	capture rename   v4063a v4063
	capture rename   v4064a v4064
