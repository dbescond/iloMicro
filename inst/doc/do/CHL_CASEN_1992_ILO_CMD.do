...
global source "CASEN"
global time "1992"
global inputFile "casen1992.dta"
...
gen ilo_edu_isced97=.
		...
		replace ilo_edu_isced97=2 if e8==1                                                           // 0 - Pre-primary education
		*replace ilo_edu_isced97=3 if e8==3                                                           // 1 - Primary education or first stage of basic education
		replace ilo_edu_isced97=4 if inlist(e8,2,4)                                                           // 2 - Lower secondary or second stage of basic education
		replace ilo_edu_isced97=5 if inlist(e8,3,5,6,8)                                                // 3 - Upper secondary education
		replace ilo_edu_isced97=6 if e8==9                                               // 4 - Post-secondary non-tertiary education
    	replace ilo_edu_isced97=7 if e8==7                                              // 5 - First stage of tertiary education
 		replace ilo_edu_isced97=8 if e8==10                                                            // 6 - Second stage of tertiary education
...
gen ilo_job1_how_actual =  o14 if ilo_lfs == 1 & o14!=99
