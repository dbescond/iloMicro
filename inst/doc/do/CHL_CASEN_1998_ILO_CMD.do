...
global source "CASEN"
global time "1998"
global inputFile "casen1998.dta"
...
* -------------------------------------------------------------------------------------------
	...
	** Comment: there is not enough information to compute this variable.
	
	/*
	gen ilo_job1_ins_sector=.
		replace ilo_job1_ins_sector=1 if inlist(o8,3,4) | o8==9
...
gen ilo_job1_how_actual =  o11 if ilo_lfs == 1 & o11!=999
...
* -------------------------------------------------------------------------------------------	
	...
	gen ilo_job1_job_contract=.
		replace ilo_job1_job_contract=1 if o13==1
		replace ilo_job1_job_contract=2 if inrange(o13,2,5)
