...
global source "CASEN"
global time "2003"
global inputFile "casen2003.dta"
...
* -------------------------------------------------------------------------------------------
	...
	gen ilo_mjh=.
		replace ilo_mjh=1 if o22==2
		replace ilo_mjh=2 if o22==1
...
* Primary activity
		...
		gen ilo_job1_ste_icse93=.
			replace ilo_job1_ste_icse93=1 if inrange(o9,3,7) | o9==9
			replace ilo_job1_ste_icse93=2 if o9==1
			replace ilo_job1_ste_icse93=3 if o9==2
			/* replace ilo_job1_ste_icse93=4 if */
			replace ilo_job1_ste_icse93=5 if o9==8
...
* -------------------------------------------------------------------------------------------
	...
	* Two-digits level
	...
	gen occ_code_prim=int(o7/100) if ilo_lfs==1 & !inlist(o7,1523,1612,3574,3745,6322,6460,9831,9999)
...
* -------------------------------------------------------------------------------------------
	...
	* Primary occupation
	 ...
	 gen ilo_job1_ins_sector=.
		replace ilo_job1_ins_sector=1 if inlist(o9,3,4) | o9==9
...
/*
gen ilo_job1_how_actual =  o19_hrs/10 if ilo_lfs == 1
...
* -------------------------------------------------------------------------------------------	
		...
		gen ilo_job1_job_time=.
			replace ilo_job1_job_time=1 if o13a==2
			replace ilo_job1_job_time=2 if o13a==1
...
* -------------------------------------------------------------------------------------------	
	...
	gen ilo_job1_job_contract=.
		replace ilo_job1_job_contract=1 if o12a==1
		replace ilo_job1_job_contract=2 if inrange(o12a,2,5)
...
* Comment: Useful questions:	* o9: Status in employment
								* o9: Institutional sector 
...
* Comment.- variable used: o4 number of weeks looking for a job
	 ...
	 gen ilo_dur_details=.
		...
		replace ilo_dur_details=6 if o4>=96 & o4!=.
...
** Comment: question o6 refers to to the last two months

	gen ilo_olf_reason=.
		replace ilo_olf_reason=1 if o6==8
        replace ilo_olf_reason=2 if o6==7
        replace ilo_olf_reason=3 if inrange(o6,1,4) 
		replace ilo_olf_reason=4 if inlist(o6,5,6) | o6==9
