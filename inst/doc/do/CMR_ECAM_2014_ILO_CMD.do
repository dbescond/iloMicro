...
* Comment: National classification. Variable: S04Q11A (3 Digits). Mapping is needed. 
...
* Comment: National classification. Variable: S04Q10 (4 Digits). Mapping is needed.
...
* Comment: Variables S04Q23, S04Q24 and S04Q25 are missing to define Usual Hours.  
...
/* Useful questions:
		  ...
		  - Social security contribution (Proxy: pension funds): S04Q19A (Missing in the microdata)
		  - Place of work: Missing
		  - Size: S04Q14
		  - Paid annual leave: S04Q19B (Missing in the microdata)
		  - Paid sick leave: S04Q19C (Missing in the microdata)
*/
/*  * Social Security:
	gen social_security=.
...
* Comment: Variables S04Q30 and S04Q34 are missing in the dataset.  
...
* Comment: Not feasible as Usual Hours are not in the dataset.
...
* Comment: Variable S04Q41 is missing in the microdata
/*
	* Detailed categories		
    gen ilo_dur_details=.
