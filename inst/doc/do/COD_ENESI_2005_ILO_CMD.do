...
* Comment: 
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if  m6_situa==1                                    // Single
		replace ilo_mrts_details=2 if inlist(m6_situa,2,3)                           // Married
		replace ilo_mrts_details=3 if  m6_situa==4                                    // Union / cohabiting
		replace ilo_mrts_details=4 if  m6_situa==6                                    // Widowed
		replace ilo_mrts_details=5 if  m6_situa==5                                    // Divorced / separated
