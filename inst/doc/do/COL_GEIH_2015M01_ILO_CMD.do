...
* NOTES: 
* Files created: Standard variables on GEIH Colombia 2015M01
...
cd "$inpath\\`M'_dta"
   use "Cabecera - Cara", clear /*Características generales*/
...
clear all
cd "$inpath\\`M'_dta"
   use "Resto - Caracte", clear   /*Características generales*/
