...
global source "LFS"
global time "2015"
global inputFile "COL_LFS_2015_All"
...
* to be used there's a appending process carried out before hand (monthly dta files) and 
* merging the final annual weight to be used, to finally save and use the resultant dataset.

*------------------------------------------*
*--- 0. Merging monthly dta files ---------*
*------------------------------------------*

cd "$inpath"
   use "${outpath}M01\ORI\COL_LFS_2015M01_All", clear
...
gen to_drop_3 = "Enero" if to_drop_2=="01"
	...
	replace to_drop_3 = "Anual" if to_drop_2==
