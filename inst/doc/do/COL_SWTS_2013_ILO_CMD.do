...
global country "COL" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2013"  /*time*/
global inputFile "COL_SWTS_2013.dta" /*name of the input file in stata format*/
...
* Comment:
	...
	* Detailed
	gen ilo_edu_isced97=.
		replace ilo_edu_isced97=1 if   ep726==1                     // No schooling
