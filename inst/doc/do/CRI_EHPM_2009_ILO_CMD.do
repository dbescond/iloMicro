* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Costa Rica, 2009
* DATASET USED: Costa Rica, EHPM, 2009
* NOTES: 
* Files created: Standard variables CRI_EHPM_2009_FULL.dta and CRI_EHPM_2009_ILO.dta
...
global source "EHPM"
global time "2009"
global inputFile "CRI_INEC_EHPM_2009_V01"
...
* Comment: 
	...
	gen ilo_sex=.
	    replace ilo_sex=1 if b04==1            // Male
		replace ilo_sex=2 if b04==2            // Female
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - Only asked to people aged 2 years old or more and therefore the rest
*            are classified under "No schooling".
*          - Given the definition of the levels of education, ISCED97 is being chosen
...
*          - Highest level concluded.
	...
	* Detailed
	gen ilo_edu_isced97=.
		replace ilo_edu_isced97=1 if  b08==0 | b08==.                           // No schooling
		replace ilo_edu_isced97=2 if  inrange(b08,1,15)                         // Pre-primary education
		replace ilo_edu_isced97=3 if  inrange(b08,16,22) | inlist(b08,31,32)    // Primary education or first stage of basic education
		replace ilo_edu_isced97=4 if  inrange(b08,23,25) | inrange(b08,33,36)   // Lower secondary education or second stage of basic education
		replace ilo_edu_isced97=5 if  inlist(b08,26,29,37,41,42,51,52)          // Upper secondary education
		replace ilo_edu_isced97=6 if  inlist(b08,43,44,49)                      // Post-secondary non-tertiary education
		replace ilo_edu_isced97=7 if  inlist(b08,53,54,55)                      // First stage of tertiary education (not leading directly to an advanced research qualification)
		replace ilo_edu_isced97=8 if  inlist(b08,56,57,58,59)                   // Second stage of tertiary education (leading to an advanced research qualification)                               
