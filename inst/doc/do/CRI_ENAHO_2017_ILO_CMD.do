...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: variables.- a13; a14; nivinst; escolari 
...
* Comment: question made to people aged 10 years or above.
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if a6==6                                     // Single
		replace ilo_mrts_details=2 if a6==2                                     // Married
		replace ilo_mrts_details=3 if a6==1                                     // Union / cohabiting
		replace ilo_mrts_details=4 if a6==5                                     // Widowed
		replace ilo_mrts_details=5 if inlist(a6,3,4)                            // Divorced / separated
...
*/
    * Aggregate  	
	gen ilo_dsb_aggregate=.
	    replace ilo_dsb_aggregate=1 if a8a==0 & a8b==0                          // Persons without disability
		replace ilo_dsb_aggregate=2 if a8a!=0 | a8b!=0	                        // Persons with disability
...
* Comment: 
	...
	gen ilo_lfs=.
		...
		replace ilo_lfs=1 if b4==1 & ilo_wap==1						            // Employed: temporary absent
		replace ilo_lfs=2 if inlist(b6,8,9) & ilo_lfs!=1 & ilo_wap==1			// Unemployed: three criteria
	 ...
	 gen ilo_job1_ste_icse93=.
		...
		* replace ilo_job1_ste_icse93=3 if c12==1 & inlist d1==3 & ilo_lfs==1   // Own-account workers
		 ...
		 *replace ilo_job1_ste_icse93=4 if  & ilo_lfs==1                        // Members of producers' cooperatives
		 replace ilo_job1_ste_icse93=5 if inlist(d1,4,5) & ilo_lfs==1           // Contributing family workers
