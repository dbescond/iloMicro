...
********************************************************************************
********************************************************************************
* Annual weights are provided in the same dataset. To obtain the annual dataset 
* an appending process is carried out beforehand (april and october files). 
* The resultant database is saved and then used for the pre-processing of annual
* indicators.
...
use "${outpath}Q2\ORI\\${country}_${source}_${time}Q2_All", clear
    append using "${outpath}Q4\ORI\\${country}_${source}_${time}Q4_All", force 
...
* Comment: 
	...
	gen ilo_wgt=.
	    replace ilo_wgt=eft_factor_exp/2 
