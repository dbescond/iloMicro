* TITLE OF DO FILE: ILO Microdata Preprocessing code template - DOMINICAN REPUBLIC, 2015
* DATASET USED: DOMINICAN REPUBLIC, SWTS, 2015
* NOTES: 
* Files created: Standard variables DOM_SWTS_2015_FULL.dta and DOM_SWTS_2015_ILO.dta
...
global country "DOM" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "DOM_SWTS_2015.dta" /*name of the input file in stata format*/
...
/* Useful questions:
	...
	* 2) NATURE OF JOB: FORMAL/INFORMAL EMPLOYMENT
	gen ilo_job1_ife_nature=.
	    ...
	    replace ilo_job1_ife_nature=1 if ilo_lfs==1 & ilo_job1_ife_nature!=2 & infemp==1
...
* Comment: 
	...
	* Employees
	gen ilo_job1_lri_ees = .
	    replace ilo_job1_lri_ees = e14amount if ilo_job1_ste_aggregate==1 & e14amount>0
	...
	* Self-employed
	gen ilo_job1_lri_slf = .
	    replace ilo_job1_lri_slf =   e24amount    if ilo_job1_ste_aggregate==2 & e24amount>0
