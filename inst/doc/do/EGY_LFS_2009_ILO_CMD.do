...
* Comment: 
	...
	* Comment: ISIC Rev. 4 classification being used (except for 2008, where ISIC Rev. 3.1 is used) 
		...
		gen preveco_cod=int(unemp_lseco/100) if ilo_lfs==2 & unemp_lseco!=0 & ilo_cat_une==1 
...
if year==2008 {
	...
	gen prevocu_cod=int(unemp_lst_occ/1000) if ilo_lfs==2 & unemp_lst_occ!=0 & ilo_cat_une==1 
