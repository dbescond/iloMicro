...
global source "LFS"
global time "2014"
global inputFile "EGY_LFS_2014_ORI.dta"
...
cd "$inpath"
	...
	replace govern=GOVERN if govern==.
	replace marcd=MARCD if marcd==.
	replace sefa=SEFA if sefa==.	
	
	drop SEX AGE GOVERN MARCD SEFA
