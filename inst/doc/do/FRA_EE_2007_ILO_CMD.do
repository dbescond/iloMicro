...
global time "2007"  /*time*/
global inputFile "FRA_EE_2007.dta" /*name of the input file in stata format*/
...
* Comment: 
	...
	gen ilo_job1_ins_sector=.
		replace ilo_job1_ins_sector=1 if inlist(chpub,1,2,3)                       & ilo_lfs==1    // Public
...
* Comment: 
	...
	* 2-digit level
	gen ilo_preveco_isic3_2digits = .
	    replace ilo_preveco_isic3_2digits = nafa  if ilo_lfs==2 & ilo_cat_une==1
...
if !_rc {
		...
		gen ilo_olf_reason=.
			...
			replace ilo_olf_reason=3 if  inlist(decr,2,3,4)          & ilo_lfs==3             // Personal/Family-related
