...
global source "HS"
global time "2013"
global inputFile "GHA_HS_2013_ORI"
...
* Comment: 
	...
	gen ilo_mjh=.
		replace ilo_mjh=1 if (s4aq4==1 | s4aq4==.)
		replace ilo_mjh=2 if inlist(s4aq4,2,3,4,5)
...
* Comment: Useful questions:	* s4aq20: Status in employment
	...
	gen ilo_job1_ife_prod=.
		replace ilo_job1_ife_prod=1 if (!inlist(s4aq21,1,2,3,4,5,6) & pw52!=1 & pw51!=1)
		replace ilo_job1_ife_prod=2 if inlist(s4aq21,1,2,3,4,5,6) | (!inlist(s4aq21,1,2,3,4,5,6) &  pw52==1) | (!inlist(s4aq21,1,2,3,4,5,6) & pw52!=1 & pw51==1)
