...
global source "ENEI"
global time "2012"
global inputFile "ENEI 2012 (Personas).dta"
...
* Comment: * check with Yves whether to include it
	/*		
...
* Comment:  --> no information about bookkeeping and registration available...!
	...
	* Useful questions: p04c06: Status in employment / Institutional sector
			...
			* given that the question on social security is being asked to all people in employment, use it as a proxy for registration
				* consider only "afiliado" as having social security coverage (check with Yves before validating)
