* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Guatemala, 2014Q2
* DATASET USED: Guatemala, ENEI, 2014Q2
* NOTES: 
* Files created: Standard variables GTM_ENEI_2014Q2_FULL.dta and GTM_ENEI_2014Q2_ILO.dta
...
global source "ENEI"
global time "2016Q1"
global inputFile "Marzo_2016_ENEI_Personas"
...
* Comment: 
    ...
    gen ilo_edu_attendance=.
		...
		replace ilo_edu_attendance=2 if p03a02==2                               // Not attending
...
*            contributing family workers
	   ...
	   * Primary activity
		gen ilo_job1_ste_icse93=.
			replace ilo_job1_ste_icse93=1 if inlist(p04c06,1,2,3,4) & ilo_lfs==1
			replace ilo_job1_ste_icse93=2 if inlist(p04c06,6,8) & ilo_lfs==1
			replace ilo_job1_ste_icse93=3 if inlist(p04c06,5,7) & ilo_lfs==1 
			/* replace ilo_job1_ste_icse93=4 if */
			replace ilo_job1_ste_icse93=5 if p04c06==9 & ilo_lfs==1
	...
	* Secondary activity
		gen ilo_job2_ste_icse93=.
			replace ilo_job2_ste_icse93=1 if inlist(p04d05,1,2,3,4) & ilo_mjh==2
			replace ilo_job2_ste_icse93=2 if (inlist(p04d05,6,8) & p04d14a==1) & ilo_mjh==2
			replace ilo_job2_ste_icse93=3 if (inlist(p04d05,5,7) & p04d14a!=1) & ilo_mjh==2
			/* replace ilo_job2_ste_icse93=4 if */
			replace ilo_job2_ste_icse93=5 if p04d05==9 & ilo_mjh==2
...
cd "$outpath"
	...
	drop time year quarter indu_code_sec occ_code_prim occ_code_sec month_p04c13b 
	drop month_p04c14b month_p04c15b month_p04c16b month_p04c17b month_p04c21b 
	drop month_p04c23 month_p04d08b month_p04d10b month_p04d11b month_p04d13
	compress
