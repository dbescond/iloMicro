...
* -------------------------------------------------------------------------------------------
	...
	gen ilo_geo=.
		replace ilo_geo=1 if zone==2
		replace ilo_geo=2 if zone==1
...
* Comment: - ISCED 11 mapping: based on the UNESCO mapping available on  http://uis.unesco.org/en/isced-mappings
	...
	gen ilo_edu_isced11=.
		replace ilo_edu_isced11=1 if (q1_13==1)                	           										// No schooling
		replace ilo_edu_isced11=2 if q1_13==2 & q1_14<6)            	       									// Early childhood education
		replace ilo_edu_isced11=3 if (q1_13==2 & q1_14==6)                      								// Primary education 
		replace ilo_edu_isced11=4 if (q1_13==3 & q1_14<11)                    									// Lower secondary education
		replace ilo_edu_isced11=5 if (q1_13==3 & q1_14==11) | (q1_13==4 & q1_15==1) | (q1_13==5 & q1_15==1)                  			// Upper secondary education
		replace ilo_edu_isced11=6 if (q1_13==4 & q1_15==2)  | (q1_13==5 & q1_15==2)	| (q1_13==4 & q1_14==12) | (q1_13==3 & q1_14==12)   // Post-secondary non-tertiary education
		replace ilo_edu_isced11=7 if q1_13==5 & q1_15==3 | (q1_13==4 & q1_15==3)                                // Short-cycle tertiary education
...
* -------------------------------------------------------------------------------------------
   ...
   gen ilo_lfs=.
	   replace ilo_lfs=1 if (q2_04==1 | q2_05==1 | qq2_06==1 | qq2_06==2 | (q2_07==1 & q2_08==2) | (q2_07==1 & (q2_09==1 | q2_09==2))) & ilo_wap==1	// Employed
	   replace ilo_lfs=1 if q2_10==1 & (q2_11 <=4 | (q2_11>=5 &(q2_12 ==1 | q2_13==1))) & ilo_wap==1			// Temporary absent
	   replace ilo_lfs=2 if (ilo_lfs!=1 & q2_14==1 & (q2_19==1 | q2_19==2) & ilo_wap==1)						// Unemployed
       replace ilo_lfs=2 if (ilo_lfs!=1 & q2_14==2 & q2_17==1 & ilo_wap==1)										// Unemployed
...
* ISIC Rev. 4
	...
	* MAIN JOB:
	gen indu_code_prim=.
	    replace indu_code_prim=substr(isic_code,1,2) if ilo_lfs==1
...
* MAIN JOB	
	gen occ_code_prim=.
	    replace occ_code_prim=substr(isco_code,1,2) if ilo_lfs==1
...
/* Useful questions:
			...
			- Bookkeeping: q3_24
			- Registration: q3_34 / q3_35
			- Place of work: q3_33
			- Size: q3_37
			- Status in employment: ilo_job1_ste_aggregate / ilo_job1_ste_icse93
			- Social security contribution / Pension: q3_23 / q3_26  
			- Paid annual leave: q3_19
			- Paid sick leave: q3_21
*/
	...
	* 1) UNIT OF PRODUCTION: FORMAL/INFORMAL SECTOR		
			...
			gen ilo_job1_ife_prod=.
				...
				replace ilo_job1_ife_prod=2 if ilo_lfs==1 & (inlist(d5,1,2,5,8) | d7==1 | e6==1 | f8==1)
...
* -------------------------------------------------------------------------------------------		
	...
	gen ilo_joball_tru = .
		replace ilo_joball_tru = 1 if  (ilo_joball_how_actual<30 & q3_11==1 & q3_12==1 & q3_06!=6)
...
* -------------------------------------------------------------------------------------------		
	...
	gen ilo_olf_dlma=.
       ...
       replace ilo_olf_dlma=2 if ((q2_14==2 & q2_19==2) | (q2_14==2 & q2_19==2)) & ilo_lfs==3	// Not seeking, available
...
* -------------------------------------------------------------------------------------------
	...
	gen ilo_olf_reason=.
		replace ilo_olf_reason=1 if	(q2_17==10 & ilo_lfs==3)| (q2_17==9 & ilo_lfs==3) | (q2_17==8 & ilo_lfs==3)	| (q2_17==7 & ilo_lfs==3)		// Labour market
		replace ilo_olf_reason=2 if (q2_17==3 | q2_17==7) & ilo_lfs==3   // Other labour market reasons
		replace ilo_olf_reason=3 if	(q2_17==1 |  q2_17==2 | q2_17==4 | q2_17==5 | q2_17==6) & ilo_lfs==3     			// Personal/Family-related
		* replace ilo_olf_reason=4 if  														// Does not need/want to work
		replace ilo_olf_reason=5 if (q2_17==99 & ilo_lfs==3) | 	(q2_17==. & ilo_lfs==3)		// Not elsewhere classified
