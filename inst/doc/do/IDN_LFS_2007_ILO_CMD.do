...
* -------------------------------------------------------------------------------------------		
	...
	/* National classification of occupations (KBJI 2002) 
	   Occupation only available for the main job. */
			 
		* KBJI 2002 aligned with ISCO-88 at the two-digit level
...
* Don't define variable due to filter questions (only option 2 could be defined)
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			Reason for not seeking job or being outside the labour force ('ilo_olf_reason') [done]
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------		
	...
	gen ilo_olf_reason=.		
		replace ilo_olf_reason=1 if	(var_olf==1 & ilo_lfs==3)			// Labour market (discouraged)
		* replace ilo_olf_reason=2 										// Other labour market reasons
		...
		replace ilo_olf_reason=5 if (var_olf==8 | var_olf==.) & ilo_lfs==3	// Not elsewhere classified
