...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - to check: 28 observations without information about sex of the 
*            respondant and therefore deleted.
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - to check: 1 observation without information about age of the 
*            respondant and therefore deleted.
...
*            or more and therefor the rest are classified under "Not elsewhere
*            classified".
...
*          - to check: Unemployment includes those satisfying ILO 3 criteria and future
*            future starters (defined as those working 0 hours during the reference
*            period because s/he has a contract and will start to work soon (not
*            as a reason for not looking for a job but as a reason for not working)).
	...
	gen ilo_lfs=.
		...
		replace ilo_lfs=2 if (ilo_lfs!=1 & q0805==1 & q0808==1) & ilo_wap==1	// Unemployed: three criteria
