...
*** ISCED-97
*** The mapping of the education variable for 2013Q4 and backwards correspond to ISCED-97.
...
gen ilo_edu_isced97=.
		replace ilo_edu_isced97 = 1 if sg24 == 1                                    // 1 "X - No schooling"
		*replace ilo_edu_isced97 = 2 if sg24                                        // 2 "0 - Pre-primary education"
		replace ilo_edu_isced97 = 3 if sg24 == 2                                    // 3 "1 - Primary education or first stage of basic education"
		replace ilo_edu_isced97 = 4 if sg24 == 3                                    // 4 "2 - Lower secondary or second stage of basic education"
		replace ilo_edu_isced97 = 5 if inlist(sg24,4,5)                             // 5 "3 - Upper secondary education"
		*replace ilo_edu_isced97 = 6 if sg24 == 5                                   // 6 "4 - Post-secondary non-tertiary education"
		replace ilo_edu_isced97 = 7 if inrange(sg24,6,10)                           // 7 "5 - First stage of tertiary education"
		*replace ilo_edu_isced97 = 8 if sg24 == 8                                   // 8 "6 - Second stage of tertiary education"
		replace ilo_edu_isced97 = 9 if sg24 == 11                                   // 9 "UNK - Level not stated"
			...
			label def isced_97_lab 1 "X - No schooling"	2 "0 - Pre-primary education" 3 "1 - Primary education or first stage of basic education"	///
									4 "2 - Lower secondary or second stage of basic education"	5 "3 - Upper secondary education"	6 "4 - Post-secondary non-tertiary education" ///
									7 "5 - First stage of tertiary education"	8 "6 - Second stage of tertiary education"	9 "UNK - Level not stated"		
...
* Aggregate
	...
	gen ilo_edu_aggregate=.
		...
		replace ilo_edu_aggregate=4 if inlist(ilo_edu_isced97,7,8,9,10)
		replace ilo_edu_aggregate=5 if ilo_edu_isced97==11
...
/*
destring staciv, replace
	
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if staciv==1                                  // Single
		replace ilo_mrts_details=2 if inlist(staciv,2,3)                         // Married
		*replace ilo_mrts_details=3 if                                           // Union / cohabiting
		replace ilo_mrts_details=4 if staciv==6                                  // Widowed
		replace ilo_mrts_details=5 if inlist(staciv,4,5)                         // Divorced / separated
...
* MAIN JOB:
 ...
 destring ate2d, replace
 	...
 	* 2-digit level	
	gen ilo_job1_eco_isic3_2digits = ate2d if ilo_lfs == 1
	...
	**** SECOND JOB:
	...
	destring ate2ds, replace
	 	...
	 	* 2-digit level	
	gen ilo_job2_eco_isic3_2digits = ate2ds if d1==1
	...
	* 1-digit level
    gen ilo_job2_eco_isic3 = .
	    ...
	    replace ilo_job2_eco_isic3=18 if ilo_job2_eco_isic3_2digits==. & d1==1
 ...
 * 1-digit level
	gen ilo_job1_ocu_isco88 =.
		...
		replace ilo_job1_ocu_isco88 = 2 if inrange(occ_code_prim,21,26) & ilo_lfs==1  // "2 - Professionals"
		replace ilo_job1_ocu_isco88 = 3 if inrange(occ_code_prim,31,34) & ilo_lfs==1  // "3 - Technicians and associate professionals"
		replace ilo_job1_ocu_isco88 = 4 if inrange(occ_code_prim,41,44) & ilo_lfs==1  // "4 - Clerks"
		replace ilo_job1_ocu_isco88 = 5 if inrange(occ_code_prim,51,55) & ilo_lfs==1  // "5 - Service workers and shop and market sales workers"
		replace ilo_job1_ocu_isco88 = 6 if occ_code_prim == 64  & ilo_lfs==1  // "6 - Skilled agricultural and fishery workers"
        replace ilo_job1_ocu_isco88 = 7 if inlist(occ_code_prim,61,62,63,65,66)  & ilo_lfs==1  // "7 - Craft and related trades workers"
        replace ilo_job1_ocu_isco88 = 8 if inrange(occ_code_prim,71,74)  & ilo_lfs==1  // "8 - Plant and machine operators and assemblers"
        replace ilo_job1_ocu_isco88 = 9 if inrange(occ_code_prim,81,86)  & ilo_lfs==1  // "9 - Elementary occupations"
        replace ilo_job1_ocu_isco88 = 10 if inrange(occ_code_prim,90,93)  & ilo_lfs==1  // "0 - Armed forces"	
...
gen occ_code_sec=.
  ...
  *1-digit level
	gen ilo_job2_ocu_isco88 =.
		...
		replace ilo_job2_ocu_isco88 = 1 if inrange(occ_code_sec,11,13) & ilo_mjh==2   // "1 - Legislators, senior officials and managers"
		replace ilo_job2_ocu_isco88 = 2 if inrange(occ_code_sec,21,26) & ilo_mjh==2 // "2 - Professionals"
		replace ilo_job2_ocu_isco88 = 3 if inrange(occ_code_sec,31,34) & ilo_mjh==2  // "3 - Technicians and associate professionals"
		replace ilo_job2_ocu_isco88 = 4 if inrange(occ_code_sec,41,42) & ilo_mjh==2  // "4 - Clerks"
		replace ilo_job2_ocu_isco88 = 5 if inrange(occ_code_sec,51,55) & ilo_mjh==2  // "5 - Service workers and shop and market sales workers"
		replace ilo_job2_ocu_isco88 = 6 if occ_code_sec == 64  & ilo_mjh==2  // "6 - Skilled agricultural and fishery workers"
        replace ilo_job2_ocu_isco88 = 7 if inlist(occ_code_sec,61,62,63,65,66)  & ilo_mjh==2  // "7 - Craft and related trades workers"
        replace ilo_job2_ocu_isco88 = 8 if inrange(occ_code_sec,71,74)  & ilo_mjh==2 // "8 - Plant and machine operators and assemblers"
        replace ilo_job2_ocu_isco88 = 9 if inrange(occ_code_sec,81,86)  & ilo_mjh==2  // "9 - Elementary occupations"
        replace ilo_job2_ocu_isco88 = 10 if inrange(occ_code_prim,90,93) & ilo_mjh==2  // "0 - Armed forces"	
		replace ilo_job2_ocu_isco88 = 11 if occ_code_sec ==.  & ilo_mjh==2  // "X - Not elsewhere classified"
...
* 2-digit level	
	gen ilo_preveco_isic3_2digits  = ate2de if ilo_cat_une==1 
...
destring prof3e, replace
    ...
    * 1-digit level
	...
	gen ilo_prevocu_isco88 =.
		...
		replace ilo_prevocu_isco88 = 1 if inrange(occ_code_prev,11,13) & ilo_cat_une == 1 // "1 - Legislators, senior officials and managers"
		replace ilo_prevocu_isco88 = 2 if inrange(occ_code_prev,21,26) & ilo_cat_une == 1 // "2 - Professionals"
		replace ilo_prevocu_isco88 = 3 if inrange(occ_code_prev,31,34) & ilo_cat_une == 1  // "3 - Technicians and associate professionals"
		replace ilo_prevocu_isco88 = 4 if inrange(occ_code_prev,41,44) & ilo_cat_une == 1  // "4 - Clerks"
		replace ilo_prevocu_isco88 = 5 if inrange(occ_code_prev,51,55) & ilo_cat_une == 1  // "5 - Service workers and shop and market sales workers"
		replace ilo_prevocu_isco88 = 6 if occ_code_prev == 64  & ilo_cat_une == 1 // "6 - Skilled agricultural and fishery workers"
        replace ilo_prevocu_isco88 = 7 if inlist(occ_code_prev,61,62,63,65,66)  & ilo_cat_une == 1  // "7 - Craft and related trades workers"
        replace ilo_prevocu_isco88 = 8 if inrange(occ_code_prev,71,74)  & ilo_cat_une == 1  // "8 - Plant and machine operators and assemblers"
        replace ilo_prevocu_isco88 = 9 if inrange(occ_code_prev,81,86)  & ilo_cat_une == 1 // "9 - Elementary occupations"
        replace ilo_prevocu_isco88 = 10 if inrange(occ_code_prev,90,93)  & ilo_cat_une == 1  // "0 - Armed forces"
		replace ilo_prevocu_isco88 = 11 if occ_code_prev==.  & ilo_cat_une == 1  // "X - Not elsewhere classified"
