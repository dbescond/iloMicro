* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Kyrgyzstan, 2013
* DATASET USED: Kyrgyzstan, SWTS, 2013
* NOTES: 
* Files created: Standard variables KGZ_SWTS_2013_FULL.dta and KGZ_SWTS_2013_ILO.dta
...
global country "KGZ" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2012"  /*time*/
global inputFile "KGZ_SWTS_2013.dta" /*name of the input file in stata format*/
