* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Lebanon, 2014
* DATASET USED: Lebanon, SWTS, 2014
* NOTES: 
* Files created: Standard variables LBN_SWTS_2014_FULL.dta and LBN_SWTS_2014_ILO.dta
...
global country "LBN" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2014"  /*time*/
global inputFile "LBN_SWTS_2014.dta" /*name of the input file in stata format*/
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: no information on geographical coverage
	/*
	gen ilo_geo=.
