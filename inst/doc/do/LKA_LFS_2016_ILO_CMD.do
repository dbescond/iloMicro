* TITLE OF DO FILE: ILO Microdata Preprocessing code template - SRI LANKA, 2016
* DATASET USED: SRI LANKA, LFS, 2016
* NOTES: 
* Files created: Standard variables LKA_LFS_2016_FULL.dta and LKA_LFS_2016_ILO.dta
...
global source "LFS"
global time "2016"
global inputFile "2016LFSAnnual_OutFile_Without_Computer"
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - Original question refers to the current education attainment.
*          - Only asked to those aged 5 years old or more and therefore
*          - Master's (7) includes doctoral studies (8) 
