* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Moldova, Republic of, 2015
* DATASET USED: Moldova, Republic of, SWTS, 2015
* NOTES: 
* Files created: Standard variables MDA_SWTS_2015_FULL.dta and MDA_SWTS_2015_ILO.dta
...
global country "MDA" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "MDA_SWTS_2015.dta" /*name of the input file in stata format*/
