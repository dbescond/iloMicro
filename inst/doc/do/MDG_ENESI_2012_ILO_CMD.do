...
global source "ENESI"
global time "2012"
global inputFile "MDG_LFS_2012.dta"
...
** Variable M6:
** 1. Manambady == married
** 2. Fiarahana tsotra (union libre) == Simple Group (free union)
** 3. Mpitovo (mbola tsy nanambady) ==  Single (never married)
** 4. Nisara-panambadiana  == Divorced
** 5. Maty vady == Widower
...
* Comment:  ISCO-88 being used
	...
	* Two digit level
	...
	gen ilo_job1_ocu_isco88_2digits = . 
	    replace ilo_job1_ocu_isco88_2digits = occ_code_prim if ilo_lfs==1 & !inlist(occ_code_prim,98,99)
		...
		* Secondary occupation
		  ...
		  gen ilo_job2_ocu_isco88_2digits = . 
			replace ilo_job2_ocu_isco88_2digits = occ_code_sec if ilo_mjh==2 & occ_code_sec!=99
...
* Comment: For the identification of the household sector, the criterion ISCO88==62 has been excluded due to a probable issue in the classification
			* Note that out of a total of 22'535 observations having a value for ISCO88 at the two digit level, 794 are considered as "skilled agricultural and fishery workers" (code 61)
			* and 5'227 (i.e. 23.42% of the observations) are considered as "Subsistence agricultural and fishery workers".
	...
	* Useful questions: ap4: Institutional sector 
		...
		gen ilo_job1_ife_prod=.
			...
			replace ilo_job1_ife_prod=3 if ap4==6 | (!inlist(ap4,1,2,6) & ap12a==4) | ilo_job1_eco_isic4_2digits==97
