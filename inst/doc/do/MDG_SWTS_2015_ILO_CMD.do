...
* DATASET USED: Madagascar, SWTS, 2015
* NOTES: 
* Files created: Standard variables MDG_SWTS_2015_FULL.dta and MDG_SWTS_2015_ILO.dta
...
global country "MDG" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "MDG_SWTS_2015.dta" /*name of the input file in stata format*/
