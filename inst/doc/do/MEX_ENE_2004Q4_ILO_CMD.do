...
global country "MEX"  
global source "ENE"  /*survey: Acronym from the workflow*/
global time "2004Q4"  /*time*/
global inputFile "ene404.dta" /*name of the input file in stata format*/
...
* ------------------------------------------------------------------------------
* Comment: 
** A_MET??? ENOE: T_LOC (tamaño del municipio)
	gen ilo_geo=.
...
* Comment: 
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if  e_civ==                                         // Single
