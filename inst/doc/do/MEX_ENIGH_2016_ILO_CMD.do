* TITLE OF DO FILE: ILO Microdata Preprocessing code template - MEX, 2016
* DATASET USED: MEX, ENIGH, 2016
* NOTES: 
* Files created: Standard variables MEX_ENIGH_2016_FULL.dta and MEX_ENIGH_2016_ILO.dta
...
global country "MEX" /*ref_area: ISO 3 Code from the workflow*/
global source "ENIGH"  /*survey: Acronym from the workflow*/
global time "2016"  /*time*/
global inputFile "" /*name of the input file in stata format*/
