* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Macedonia, 2012
* DATASET USED: Macedonia, SWTS, 2012
* NOTES: 
* Files created: Standard variables MKD_SWTS_2012_FULL.dta and MKD_SWTS_2012_ILO.dta
...
global source "SWTS"
global time "2012"
global inputFile "MKD_SWTS_2012.dta"
...
* ------------------------------------------------------------------------------
	...
	destring ilo_geo, replace
	    *replace ilo_geo=1 if  urban==1        // Urban 
		*replace ilo_geo=2 if  urban==2        // Rural
...
* ------------------------------------------------------------------------------
   ...
   * ICSE 1993
	 gen ilo_job1_ste_icse93=.
		 ...
		 replace ilo_job1_ste_icse93=6 if (ilo_job1_ste_icse93==. |statusinemp==6) & ilo_lfs==1   // Workers not classifiable by status
	...
	* 1-digit level 				
	gen ilo_job1_ocu_isco08=.                        
		...
		*replace ilo_job1_ocu_isco08=10 if (ilo_job1_ocu_isco08==0 & ilo_lfs==1)  // Armed forces
		 ...
		 replace ilo_job1_ocu_isco08=11 if inlist(occu,999,.) & ilo_lfs==1 
