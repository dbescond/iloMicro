* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Macedonia, 2014
* DATASET USED: Macedonia, SWTS, 2014
* NOTES: 
* Files created: Standard variables MKD_SWTS_2014_FULL.dta and MKD_SWTS_2014_ILO.dta
...
global country "MKD" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2014"  /*time*/
global inputFile "MKD_SWTS_2014.dta" /*name of the input file in stata format*/
