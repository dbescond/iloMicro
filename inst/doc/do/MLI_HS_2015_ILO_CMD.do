...
* Comment: size : 6+ instead of 5+ considered (given options in original question)
	...
	* Useful questions: ap4: Institutional sector
	...
	gen ilo_job1_ife_prod=.
		replace ilo_job1_ife_prod=1 if !inlist(ap4,1,2,4,5,6,7) & ap8c1!=2 & ap6ba!=1 & ap6bb!=1 & ap6bc!=1 & ap6bd!=1 & ((ilo_job1_ste_aggregate==1 & ap16b6!=1) | ilo_job1_ste_aggregate!=1) & ///
									(!inlist(ap7,3,7,9) | (inlist(ap7,3,7,9) & !inrange(ap5,4,9)))
		replace ilo_job1_ife_prod=2 if inlist(ap4,1,2,4,5,6) | (!inlist(ap4,1,2,4,5,6,7) & ap8c1==2) | (!inlist(ap4,1,2,4,5,6,7) & ap8c1!=2 & (ap6ba==1 | ap6bb==1 | ap6bc==1 | ap6bd==1)) | ///
						(!inlist(ap4,1,2,4,5,6,7) & ap8c1!=2 & ap6ba!=1 & ap6bb!=1 & ap6bc!=1 & ap6bd!=1 & ((ilo_job1_ste_aggregate==1 & ap16b6==1) | ///
