* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Montenegro, 2015
* DATASET USED: Montenegro, SWTS, 2015
* NOTES: 
* Files created: Standard variables MNE_SWTS_2015_FULL.dta and MNE_SWTS_2015_ILO.dta
...
global country "MNE" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "MNE_SWTS_2015.dta" /*name of the input file in stata format*/
