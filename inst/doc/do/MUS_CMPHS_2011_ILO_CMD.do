* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Mauritius, 2011
* DATASET USED: Mauritius, CMPHS, 2011
* NOTES: 
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - Even though there exists information on the level of education, the 
*            lack of an official mapping between the codes displayed from the original
   ...
   * Aggregate level
	...
	* 2-digit level
	gen ilo_job2_eco_isic4_2digits = . 
	    replace ilo_job2_eco_isic4_2digits = int(secondactnew/1000) if ilo_mjh==2
...
*          - No information available for the second job.
	...
	* 2-digit level 
    gen ilo_job1_ocu_isco08_2digits = . 
	    replace ilo_job1_ocu_isco08_2digits = occup if ilo_lfs==1
