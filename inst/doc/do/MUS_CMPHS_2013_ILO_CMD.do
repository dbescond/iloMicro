* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Mauritius, 2013
* DATASET USED: Mauritius, CMPHS, 2013
* NOTES: 
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: - Employees include: employees (3) and apprentice (4).
