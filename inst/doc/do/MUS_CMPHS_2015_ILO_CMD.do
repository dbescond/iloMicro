    ...
    * 1) UNIT OF PRODUCTION: FORMAL/INFORMAL SECTOR
	gen ilo_job1_ife_prod=.
		...
		replace ilo_job1_ife_prod=2 if ilo_lfs==1 & ilo_job1_ife_prod!=3 & ///
									   ...
									   (inlist(estname,0,5,6,7,8,.) & inlist(typeacc,1,2,.) & ilo_job1_ste_icse93==1 & social_security!=1 & wrkplcloc==1 & inlist(size,2,3)) | ///
									   (inlist(estname,0,5,6,7,8,.) & inlist(typeacc,1,2,.) & ilo_job1_ste_icse93!=1 & wrkplcloc==1 & inlist(size,2,3)))
