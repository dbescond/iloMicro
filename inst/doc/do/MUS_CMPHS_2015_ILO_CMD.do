* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Mauritius, 2015
* DATASET USED: Mauritius, CMPHS, 2015
* NOTES: 
* Files created: Standard variables MUS_CMPHS_2015_FULL.dta and MUS_CMPHS_2015_ILO.dta
...
* Comment: 
	...
	gen ilo_job1_job_contract=.
		replace ilo_job1_job_contract=1 if emptype==1 & ilo_lfs==1               	  // Permanent
		replace ilo_job1_job_contract=2 if emptype==2 & ilo_lfs==1               	  // Temporary
...
* Comment: 
	...
	* 2-digit level
	gen ilo_preveco_isic4_2digits = . 
	    replace ilo_preveco_isic4_2digits = int(lastworked/1000) if ilo_lfs==2 & ilo_cat_une==1
                * labels already defined for main job
...
* Comment: 
	...
	* 2-digit level 
    gen ilo_prevocu_isco08_2digits = . 
	    replace ilo_prevocu_isco08_2digits = int(lastoccup/1000) if ilo_lfs==2 & ilo_cat_une==1
                * labels already defined for main job
