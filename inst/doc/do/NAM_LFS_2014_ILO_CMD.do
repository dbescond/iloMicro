...
* Comment: 
	...
	gen ilo_lfs=.
		...
		replace ilo_lfs=2 if (ilo_lfs!=1 & G01Ready2Work==1 & (G03Look4Work==1 | G05YNotLook==4))
...
* Comment: "Unspecified Duration" is being considered as unknown
	...
	gen ilo_job1_job_contract=.
		replace ilo_job1_job_contract=1 if E12Contract==2
		replace ilo_job1_job_contract=2 if E12Contract==1
...
* Comment: Registration --> "In process of registration" considered as not registered
	...
	* Useful questions: E07EntityType: Institutional sector 
	...
	gen ilo_job1_ife_prod=.
		...
		replace ilo_job1_ife_prod=3 if inlist(E07EntityType,7,8,9) | ilo_job1_ocu_isco88_2digits==62 | ilo_job1_eco_isic4_2digits==97
...
* Comment: use "F20HowManyHours" as a proxy for the availability criterion (indicating the number of hours that the person could have worked additionally)
	...
	gen ilo_joball_tru=1 if ilo_job1_job_time==1 & F09LikeMore==1 & F11HowManyHours!=.
