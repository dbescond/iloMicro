...
global inputFile "NGA_GHS_2010.dta" /*name of the input file in stata format*/
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: Question only asked to a very reduced set of individuals. Should it be dropped?
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: Variable s3aq15 does not only allow to derive status in employment at the aggregate level as Self employed category is missing 
/*
   * MAIN JOB
   * ICSE 1993
...
* ------------------------------------------------------------------------------
* ------------------------------------------------------------------------------
* Comment: Most of the individuals are classified "X - Not elsewhere classified". Should it be dropped?
