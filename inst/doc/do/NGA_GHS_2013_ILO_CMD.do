...
* Comment: 
	...
	gen ilo_dsb_details=.
		...
		replace ilo_dsb_details=4 if s4aq23==4 | s4aq25==4 | s4aq27==4 | s4aq29==4 | s4aq31==4 | s4aq33==4 
			* force missing values into category "no difficulty"
...
* Comment: given that variable s3aq12a does not allow to make any distinction between self-employed and employers, the ICSE classification can't be done
	...
	* Aggregate categories
		...
		* elsewhere classified" as they would usually end up
		...
		gen ilo_job1_ste_aggregate=.
			...
			replace ilo_job1_ste_aggregate=2 if inlist(s3aq12a,9,10)
	...
	* Aggregate categories
		...
		gen ilo_job2_ste_aggregate=.
			...
			replace ilo_job2_ste_aggregate=2 if inlist(s3aq24a,9,10)
...
* Comment: due to a skip pattern, persons replying to s3aq6 are redirected to question 9 --> therefore no observation can be captured for 
				* ilo_dis --> don't define
...
cd "$outpath"
		...
		drop /*indu_code_* */ occ_code_*  /* prev*_cod */   salary_month inkind_month considered
