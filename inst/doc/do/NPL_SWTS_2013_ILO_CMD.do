* TITLE OF DO FILE: ILO Microdata Preprocessing code template - NEPAL, 2013
* DATASET USED: NEPAL, SWTS, 2013
* NOTES: 
* Files created: Standard variables NPL_SWTS_2013_FULL.dta and NPL_SWTS_2013_ILO.dta
...
global inputFile "NPL_SWTS_2013.dta" /*name of the input file in stata format*/
...
* Comment: 
	...
	gen ilo_geo=.
	    replace ilo_geo=1 if urb_rural==2         // Urban 
		replace ilo_geo=2 if urb_rural==1         // Rural
...
* Comment: 
	...
	gen ilo_lfs=.
		...
		replace ilo_lfs=1 if c39==1 & ilo_wap==1										// Employed: temporary absent
	...
	* 1-digit level
	...
	/*
	    ...
	    */
		...
		replace ilo_job1_eco_isic4=22 if industry==999 & ilo_lfs==1
	...
	* 1-digit level 				
	gen ilo_job1_ocu_isco08=.
		...
		*replace ilo_job1_ocu_isco08=10 if (ilo_job1_ocu_isco08==0 & ilo_lfs==1)    // Armed forces
		...
		replace ilo_job1_ocu_isco08=11 if occu==999 & ilo_lfs==1
	...
	* 2) NATURE OF JOB: FORMAL/INFORMAL EMPLOYMENT
	...
	gen ilo_job1_ife_nature=.
	    replace ilo_job1_ife_nature=2 if ilo_lfs==1 & ///
										 ...
										 (ilo_job1_ste_icse93==1 & benefit_servd==1 & benefit_servc==1) | ///
...
* Comment: 
    ...
    ***********
	gen ilo_job1_lri_ees = .
	    replace ilo_job1_lri_ees = d15inc      if ilo_job1_ste_aggregate==1 & d15inc>=0
		replace ilo_job1_lri_ees=ilo_job1_lri_ees + d17amt if ilo_job1_ste_aggregate==1 & d17amt>=0 & d17==1
		replace ilo_job1_lri_ees = ilo_job1_lri_ees *(5*52/12) if d19==1
		replace ilo_job1_lri_ees = ilo_job1_lri_ees *(52/12) if d19==2
		replace ilo_job1_lri_ees = ilo_job1_lri_ees *(26/12) if d19==3
	    replace ilo_job1_lri_ees = .     if ilo_lfs!=1
		        lab var ilo_job1_lri_ees "Monthly earnings of employees - main job"
	
	* Self-employed
	gen ilo_job1_lri_slf = .
	    replace ilo_job1_lri_slf = d28      if ilo_job1_ste_aggregate==2 & d28>=0
		 replace ilo_job1_lri_slf = ilo_job1_lri_slf + d30  if ilo_job1_ste_aggregate==2 & d30>=0 & d29==1
...
* Comment: 
		...
		gen ilo_olf_reason=.
			...
			replace ilo_olf_reason=5 if (ilo_olf_reason==.|reason_notseeking==99 & !e14==6) & ilo_lfs==3     // Not elsewhere classified
