* TITLE OF DO FILE: ILO Microdata Preprocessing code template - PAK, 2015
* DATASET USED: PAK LFS 2015
* NOTES:
* Author: Roger Gomis
...
global source "LFS"
global time "2015"
global inputFile "PAK_LFS_2014_2015"
...
rename *, lower
* sections
rename *sec4_col* *sec_4_*
rename *sec5_col* *sec_5_*
rename *sec9_col* *sec_9_*
rename *sec7_col* *sec_7_*
rename *sec6_col* *sec_6_*
rename *sec8_col* *sec_8_*

*variables, grouped by section
rename sec_5_17_1 sec_5_171

rename sec_7_33 sec_7_3_3
rename sec_7_43 sec_7_4_3
rename sec_7_53 sec_7_5_3
...
*-- annual
	...
	gen ilo_wgt=weights * 186.19 / 163.532738  if to_drop_2==-9999
		lab var ilo_wgt "Sample weight"		

*-- quarter_1                
    if `Q' == 1 {
	    replace ilo_wgt = weights * 186.19 / 163.532738 *4
		lab var ilo_wgt "Sample weight"	
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
	gen region=substr(process_code,5,1)
...
*note that post secondary level non tertirary is empty
	...
	recode sec_4_9 (1=1) (2/3=2) (4=3) (5=4) (6/7=5) (8/12=7) (13/14=9) (15=10) (16 . 0 18 34=11), gen(ilo_edu_isced11)
...
* -------------------------------------------------------------------------------------------		
	...
	* if the respondant does not know the variable is not defined
		gen ilo_job1_ins_sector=.
			...
			* lots of missing values due to the question not being asked to workers in agriculture + 1 additional
			...
			* All jobs
				...
				* Employees
					gen ilo_job1_lri_ees=.
						...
						replace ilo_job1_lri_ees=sec_7_5_3*365/12 if (sec_7_5_3 >0 & ilo_job1_ste_aggregate==1& ilo_job1_lri_ees==.)
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------		
/* Silenced beacuse almost all end up in non classified
	gen ilo_olf_dlma=.
