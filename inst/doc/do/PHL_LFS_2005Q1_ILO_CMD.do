...
global source "LFS"
global time "2005Q1"
global inputFile "PHL_LFS_2005Q1.dta"
...
* Don't define ilo_* variables for overseas workers and people employed in Filipino embassies and consulates
	...
	capture gen  ILO_EXCLUDE = c08_conwr
	capture gen  ILO_EXCLUDE = c11_conwr
	destring ILO_EXCLUDE, force replace
...
* Comment: 
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if cc08_mstat==1                             // Single
		replace ilo_mrts_details=2 if cc08_mstat==2                             // Married
		*replace ilo_mrts_details=3 if                                          // Union / cohabiting
		replace ilo_mrts_details=4 if cc08_mstat==3                             // Widowed
		replace ilo_mrts_details=5 if cc08_mstat==4                             // Divorced / separated
...
* Comment: 
	...
	* Primary activity
	...
	capture gen ilo_PCLASS = c17_pclass
...
* Comment: 
		...
		capture gen ilo_PROC = c14a_procc
...
* Comment:	Question asks how much time ther person has spent looking for another job
		...
		capture gen ilo_WEEKS = c38_weeks
		capture gen ilo_WEEKS = c37_weeks
...
* Comment:
		...
		capture gen ilo_FLWK = c39_flwrk
		capture gen ilo_FLWK = c38_flwrk
...
* Comment: use ISCO-08 classification (for periods after and including 2012Q3 )
		...
		capture gen ilo_POCC = c43a_pocc
		capture gen ilo_POCC = c42a_pocc
		capture gen ilo_POCC = c42_pocc
