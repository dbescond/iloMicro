* TITLE OF DO FILE: ILO Microdata Preprocessing code template - PRT, 2007Q4
* DATASET USED: PRT, IE, 2017Q4
* Files created: Standard variables PRT_IE_2007Q4_FULL.dta and PRT_IE_2007Q4_ILO.dta
...
global source "IE"   
global time "2007Q4"   
global inputFile "IE_2007_4t.dta" 
...
if todrop <= "2005Q4" {			
    gen ilo_edu_attendance=.
		replace ilo_edu_attendance=1 if ieq90==1                                 // Attending
		replace ilo_edu_attendance=2 if ieq90==2                                 // Not attending
		replace ilo_edu_attendance=3 if ilo_edu_attendance==.                    // Not elsewhere classified
}
 ...
 * Comment:
	...
	gen ilo_joball_tru = .
		 replace ilo_joball_tru = 1 if ieq53==1 & (ieq56_1!=. | ieq56_2!=.) & ieq56a==1  & ilo_lfs==1
