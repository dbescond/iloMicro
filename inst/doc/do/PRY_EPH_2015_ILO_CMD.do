...
if ${time} < 2013 & ${time} > 2010  {
 ...
 foreach var of varlist b14-b33 {
...
if ${time} ==2010  {
 ...
 foreach var of varlist b10-b35 {
 rename `var' test_`var'
 }
...
* -------------------------------------------------------------------------------------------
	...
	gen ilo_mjh=.
		replace ilo_mjh=1 if b31==6 & ilo_lfs==1
		replace ilo_mjh=2 if b31==1 & ilo_lfs==1
...
* -------------------------------------------------------------------------------------------			
	...
	** additionally some can be directed to the corporate sector
	replace todrop_institutional=1 if b29>1&b29<5
