...
global source "LFS"
global time "2008"
global inputFile "LFS-2008-e.DTA"
...
* -------------------------------------------------------------------------------------------
	...
	*** Comment: this variable cannot be computed because the variable that defines school attendance is not correctly defined. 
...
* main activity:	
	gen indu_code_prim=int(pw20/100) if ilo_lfs==1

* second activity:	
	** Comment: for second activity, this variable can be only computed after 2007
...
** Comment:  ISCO-88 classification used
	...
	* Two-digits level
		...
		** No possible to compute. The data given by the variable pw22 is at one-digit level.
	...
	* 1 digit level
		...
		* Primary activity
		...
		gen occ_code_prim_1dig=pw22 if ilo_lfs==1
...
* 2-digits level
	...
	gen ilo_preveco_isic3_2digits=int(pw20/100) if (ilo_lfs==2 & ilo_cat_une==1)
...
* Comment: ISCO-88 classification being used
	...
	* 1-digit level 
	...
	gen prevocu_cod=pw22 if ilo_lfs==2 & ilo_cat_une==1 
...
** Comment: this variable cannot be computed because the variable 'ilo_edu_attendance' cannot be defined. 
