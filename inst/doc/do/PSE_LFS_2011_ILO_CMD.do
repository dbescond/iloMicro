...
* Main activity:	
	gen indu_code_prim=pw20 if ilo_lfs==1 & pw20!=0
...
** Comment:  ISCO-88 classification used
	...
	* Two-digits level
		...
		* Primary occupation
		...
		gen ilo_job1_ocu_isco88_2digits=pw22 if ilo_lfs==1 & pw22!=99
...
** Comment: ISIC Rev. 3 used

* 2-digits level

	gen ilo_preveco_isic3_2digits=pw20 if (ilo_lfs==2 & ilo_cat_une==1 & pw20!=0)
...
* Comment: ISCO-88 classification being used
	...
	* Reduce it to 1-digit level 
	...
	gen prevocu_cod=int(pw22/10) if ilo_lfs==2 & ilo_cat_une==1 & pw22!=99
