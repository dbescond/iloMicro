...
* one strategic change of name

rename pw20 orig_pw20
gen pw20_new =pw21
		...
		* All jobs 
		...
		gen ilo_joball_how_actual_bands=.
			...
			replace ilo_joball_how_actual_bands=8 if ilo_lfs==1 & ilo_joball_how_actual_bands==.
				...
				*MARK_NEW
				foreach var of varlist ilo_joball_how_usual ilo_job1_how_actual ilo_job2_how_actual ilo_joball_how_actual ilo_job1_how_actual_bands ilo_joball_how_actual_bands {
