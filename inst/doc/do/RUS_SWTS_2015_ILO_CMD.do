* TITLE OF DO FILE: ILO Microdata Preprocessing code template - RUSSIAN FEDERATION, 2015
* DATASET USED: RUSSIAN FEDERATION, SWTS, 2015
* NOTES: 
* Files created: Standard variables RUS_SWTS_2015_FULL.dta and RUS_SWTS_2015_ILO.dta
...
global country "RUS" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "RUS_SWTS_2015.dta" /*name of the input file in stata format*/
