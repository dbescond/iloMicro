...
* -------------------------------------------------------------------------------------------
   ...
   gen ilo_lfs=.
	   ...
	   replace ilo_lfs=2 if (ilo_lfs!=1 & (g1==1 | g2==1) & g7==1 & ilo_wap==1)													// Unemployed
...
* -------------------------------------------------------------------------------------------
    ...
    gen ilo_mjh=.
	    replace ilo_mjh=2 if (d32==1 & ilo_lfs==1)                          
		replace ilo_mjh=1 if (d32==2 & ilo_lfs==1)
...
* -------------------------------------------------------------------------------------------
   ...
   gen ilo_job1_job_contract=.
	   replace ilo_job1_job_contract=1 if d1==1 & ilo_lfs==1                // Permanent (unlimited duration)
	   replace ilo_job1_job_contract=2 if d1==2 & ilo_lfs==1      			// Temporary (limited duration)
	   replace ilo_job1_job_contract=3 if d1==. & ilo_lfs==1			    // Unknown
