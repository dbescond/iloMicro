* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Sierra Leone, 2015
* DATASET USED: Sierra Leone, SWTS, 2015
* NOTES: 
* Files created: Standard variables SLE_SWTS_2015_FULL.dta and SLE_SWTS_2015_ILO.dta
...
global country "SLE" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "SLE_SWTS_2015.dta" /*name of the input file in stata format*/
...
/* Useful questions:
    ...
    * 1) UNIT OF PRODUCTION: FORMAL/INFORMAL SECTOR
	gen ilo_job1_ife_prod=.	         
		...
		replace ilo_job1_ife_prod=1 if ilo_lfs==1 & !inlist(ilo_job1_ife_prod,2,3) & !informal_sector==0
