...
if (`A' == 2016 & `Q' == 1) {
  ...
  *---- for 2014, 2015 & 2017 where the variable "tip" is string but float
else{
...
*           (2008). More information can be found: 
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------			
* Comment: - The total net salary received in the previous month is computed merging the exact 
*            amount for those anwering the question, and the mid-point of their interval for 
*            those who did not want to answer the exact amount but answered following the 
*            table of intervals.
*          - No informatin available on the second job.
	...
	* Self-employed
	* question refers to net salary -> only for employees; no question is asked to self-employees
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
* Comment: "Search not yet started" is being classified as "not elsewhere classied"
