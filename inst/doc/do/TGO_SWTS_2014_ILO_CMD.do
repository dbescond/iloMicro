* TITLE OF DO FILE: ILO Microdata Preprocessing code template - TOGO, 2014
* DATASET USED: TOGO, SWTS, 2014
* NOTES: 
* Files created: Standard variables TGO_SWTS_2014_FULL.dta and TGO_SWTS_2014_ILO.dta
...
global country "TGO" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2014"  /*time*/
global inputFile "TGO_SWTS_2014.dta" /*name of the input file in stata format*/
...
* Comment:
	...
	* Detailed
	gen ilo_edu_isced97=.
		replace ilo_edu_isced97=1 if c1==2  | c11==1                     // No schooling
...
* Comment: 
    ...
    * Detailed
       gen ilo_dsb_details=.
             replace ilo_dsb_details=1 if (b17==1 & b18==1 & b15==1 & b16==1 )                            
             replace ilo_dsb_details=2 if (b17==2 | b18==2 | b15==2 | b16==2 )                                                 
             replace ilo_dsb_details=3 if (b17==3 | b18==3 | b15==3 | b16==3 )                                                 
             replace ilo_dsb_details=4 if (b17==4 | b18==4 | b15==4 | b16==4 )
...
* Comment: 
	...
	gen ilo_lfs=.
		...
		d13e==1 | d13f==1 |d13g==1 | employed==1 ) & ilo_wap==1				   // Employed: ILO definition
...
* Comment: 
	...
	* 1-digit level
	...
	/*
		...
		*/
		replace ilo_job1_eco_isic4=isic04 if ilo_lfs==1
