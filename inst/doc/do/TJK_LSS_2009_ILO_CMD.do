...
* Comment: 
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if m1q8==7                                   // Single
		replace ilo_mrts_details=2 if inlist(m1q8,1,2)                          // Married
		replace ilo_mrts_details=3 if m1q8==4                                   // Union / cohabiting
		replace ilo_mrts_details=4 if m1q8==6                                   // Widowed
		replace ilo_mrts_details=5 if inlist(m1q8,3,5)                          // Divorced / separated
