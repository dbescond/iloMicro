...
global source "LFS"
global time "2010"
global inputFile "TLS_LFS_2010.dta"
...
* Comment: the majority of the missing observations are related to people aged below 15 years
	...
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if h4_marital==5                                          // Single
		replace ilo_mrts_details=2 if h4_marital==1                                          // Married
		replace ilo_mrts_details=3 if h4_marital==2                                          // Union / cohabiting
		replace ilo_mrts_details=4 if h4_marital==3                                          // Widowed
		replace ilo_mrts_details=5 if h4_marital==4                                          // Divorced / separated
