* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Timor-Leste 2010
* DATASET USED: Timor-Leste LFS 2010
* NOTES: 
...
* Comment:
	...
	gen ilo_sex=.
	    replace ilo_sex=1 if h1_sex==1
		replace ilo_sex=2 if h1_sex==2 
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
*			Labour Force Status ('ilo_lfs')  [in progress-----------------------------------------------------------------]
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
* Comment: - Questions regarding the labour force status are asked to each HH member aged 10
*            years or more.
*          - Question: should we follow the 19th ICLS resolution? apparently the official report doesn't follow it. (what is it following?)
*            18th ICLS resoltion definition of employment/unemployment/outside the labour force.
