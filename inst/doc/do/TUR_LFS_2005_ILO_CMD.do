...
* Comment: 
		...
		gen ilo_geo=.
			replace ilo_geo=1 if kirkent=="KENT"
			replace ilo_geo=2 if kirkent=="KIR"
...
* -------------------------------------------------------------------------------------------
*
* Comment: Age only indicated in age bands
/*
	gen ilo_age=s6
		lab var ilo_age "Age"
	...
	* Age groups
	...
	gen ilo_age_10yrbands=.
		replace ilo_age_10yrbands=1 if s6==1
