* TITLE OF DO FILE: ILO Microdata Preprocessing code template - UGANDA, 2015
* DATASET USED: UGANDA, SWTS, 2015
* NOTES: 
* Files created: Standard variables UGA_SWTS_2015_FULL.dta and UGA_SWTS_2015_ILO.dta
...
global country "UGA" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "UGA_SWTS_2015.dta" /*name of the input file in stata format*/
