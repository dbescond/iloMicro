* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Ukraine, 2015
* DATASET USED: Ukraine, SWTS, 2015
* NOTES: 
* Files created: Standard variables UKR_SWTS_2015_FULL.dta and UKR_SWTS_2015_ILO.dta
...
global country "UKR" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2015"  /*time*/
global inputFile "UKR_SWTS_2015.dta" /*name of the input file in stata format*/
