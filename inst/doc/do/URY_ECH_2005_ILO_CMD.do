* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Uruguay, 2005
* DATASET USED: Uruguay LFS 2005
* NOTES: 
...
* -------------------------------------------------------------------------------------------
* -------------------------------------------------------------------------------------------
* Comment: - DB contains quarterly and annual weights.
...
* Comment: 
	...
	gen ilo_sex=.
	    replace ilo_sex=1 if e1==1
		replace ilo_sex=2 if e1==2
...
*            who are not currently attending.
    ...
    * For those not attending
    gen asis_edu_0=1 if e11_1>1
	gen asis_edu_1=1 if e11_2>1
	* gen asis_edu_2=1 if
	gen asis_edu_3=1 if e11_3>1
	gen asis_edu_4=1 if e11_4>1
	gen asis_edu_5=1 if (e11_5>1) | (e11_6>1)
	* gen asis_edu_6=1 if
	
	* Finished the highest level attended
	* gen high_edu_6=1 if
	gen high_edu_5=1 if (asis_edu_5==1 & e13==1)
	gen high_edu_4=1 if high_edu_5==. & ((asis_edu_4==1 & e13==1) | (asis_edu_5==1 & (e13!=1)))
	gen high_edu_3=1 if high_edu_5==. & high_edu_4==. & ((asis_edu_3==1 & e13==1) | (asis_edu_4==1 & e13!=1) | (asis_edu_5==1 & (e13!=1)))
	* gen high_edu_2=1 if
	gen high_edu_1=1 if high_edu_5==. & high_edu_4==. & high_edu_3==. & ((asis_edu_1==1 & e13==1) | (asis_edu_3==1 & e13!=1) | (asis_edu_4==1 & e13!=1) | (asis_edu_5==1 & (e13!=1)))
	gen high_edu_0=1 if high_edu_5==. & high_edu_4==. & high_edu_3==. & high_edu_1==. & ((asis_edu_0==1 & e13==1) | (asis_edu_1==1 & e13!=1) | (asis_edu_3==1 & e13!=1) | (asis_edu_4==1 & e13!=1) | (asis_edu_5==1 & (e13!=1)))
    gen high_edu_x=1 if e10==2
	...
	* Final mapping
	gen ilo_edu_isced97=.
		...
		* replace ilo_edu_isced97=4 if                                          // Lower secondary or second stage of basic education
...
* Comment:
	...
	gen ilo_edu_attendance=.
	    replace ilo_edu_attendance=1 if e9==1                                   // Attending
        replace ilo_edu_attendance=2 if e9==2                                   // Not attending
...
*             starters.
	...
	gen ilo_lfs=.
		replace ilo_lfs=1 if (f1_1==1 | f1_2==1 | f2==1) & ilo_wap==1                       // Employed
		replace ilo_lfs=2 if (ilo_lfs!=1 & f22==1 & f23==1) & ilo_wap==1                    // Unemployed: available and seeking (last week)
		replace ilo_lfs=2 if (ilo_lfs!=1 & f22==1 & f25==1) & ilo_wap==1                    // Unemployed: available and seeking (last four weeks)
		replace ilo_lfs=2 if (ilo_lfs!=1 & f22==1 & inlist(f24,2,3)) & ilo_wap==1           // Unemployed: available future starters
...
* Comment: 
	...
	gen ilo_mjh=.
		replace ilo_mjh=1 if f4==1 & ilo_lfs==1                                 // One job only    
		replace ilo_mjh=2 if f4>=2 & ilo_lfs==1                                 // More than one job
...
* Comment:
	...
	* Detailed categories:
	  gen ilo_job1_ste_icse93=.
		  replace ilo_job1_ste_icse93=1 if inlist(f7,1,2) & ilo_lfs==1	        // Employees
		  replace ilo_job1_ste_icse93=2 if f7==4 & ilo_lfs==1			        // Employers
		  replace ilo_job1_ste_icse93=3 if inlist(f7,5,6) & ilo_lfs==1		    // Own-account workers
		  replace ilo_job1_ste_icse93=4 if f7==3 & ilo_lfs==1		            // Members of producers' cooperatives
		  replace ilo_job1_ste_icse93=5 if f7==7 & ilo_lfs==1		            // Contributing family workers
		  replace ilo_job1_ste_icse93=6 if f7==. & ilo_lfs==1	                // Not classifiable
	...
	* Detailed categories:
	  gen ilo_job2_ste_icse93=.
		  replace ilo_job2_ste_icse93=1 if inlist(f13,1,2)	& ilo_mjh==2        //Employees
		  replace ilo_job2_ste_icse93=2 if f13==4 & ilo_mjh==2			        // Employers
		  replace ilo_job2_ste_icse93=3 if inlist(f13,5,6) & ilo_mjh==2		    // Own-account workers
		  replace ilo_job2_ste_icse93=4 if f13==3			                    // Producer cooperatives
		  replace ilo_job2_ste_icse93=5 if f13==7 & ilo_mjh==2		            // Contributing family workers
		  replace ilo_job2_ste_icse93=6 if f13==. & ilo_mjh==2	                // Not classifiable
...
* Comment: - National classification is based on ISIC Rev.3 (4 digit-level available).
  ...
  * ISIC Rev. 3 - 2 digit-level
  destring f6_2, replace 
  
  gen ilo_job1_eco_isic3_2digits = f6_2 if ilo_lfs==1 & f6_2<=99
      replace ilo_job1_eco_isic3_2digits = int(f6_2/100) if ilo_lfs==1 & ilo_job1_eco_isic3_2digits==.
  ...
  * SECOND JOB:
  * ISIC Rev. 3 - 2 digit-level
  destring f12_2, replace 
  
  gen ilo_job2_eco_isic3_2digits = f12_2 if ilo_mjh==2 & f12_2<=99
      replace ilo_job2_eco_isic3_2digits = int(f12_2/100) if ilo_mjh==2 & ilo_job2_eco_isic3_2digits==.
...
* Comment: - National classification is based on ISCO-88 (4 digit-level available).
    ...
    * ISCO-88 2 digits-level
    destring f5_2, replace
			
    * ISCO88
    gen ilo_job1_ocu_isco88_2digits = f5_2 if ilo_lfs==1 & f5_2<=12
	    replace ilo_job1_ocu_isco88_2digits = int(f5_2/10) if ilo_lfs==1 & ilo_job1_ocu_isco88_2digits==. & inrange(f5_2,111,933)
		replace ilo_job1_ocu_isco88_2digits = int(f5_2/100) if ilo_lfs==1 & ilo_job1_ocu_isco88_2digits==.
