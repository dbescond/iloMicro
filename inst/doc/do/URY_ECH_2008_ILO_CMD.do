* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Uruguay, 2008
* DATASET USED: Uruguay LFS 2008
* NOTES: 
* Files created: Standard variables on ECH Uruguay 2008
...
global source "ECH"
global time "2008"
global inputFile "Personas_2008_TERCEROS"
...
* Comment: 
	...
	gen ilo_sex=.
	    replace ilo_sex=1 if e27==1
		replace ilo_sex=2 if e27==2
...
*            finalization are used.
    ...
    * Attending
    gen asis_edu_0=1 if inlist(e52_1,1,2,3)
	gen asis_edu_1=1 if inlist(e52_2,1,2,3,4,5,6) | inlist(e52_3,1,2,3,4)
	gen asis_edu_2=1 if inlist(e52_4,1,2,3)
	gen asis_edu_3=1 if inlist(e52_5,1,2,3)
	gen asis_edu_4=1 if inlist(e52_7_1,1,2,3,4,5,6,7,8)
	gen asis_edu_5=1 if inlist(e52_8,1,2,3,4) | inlist(e52_9,1,2,3,4,5,6,7,8) | inlist(e52_10,1,2,3,4,5,6,7,8)
	gen asis_edu_6=1 if inlist(e52_11,1,2,3,4,5,6)
	
	* Finished the highest level attended
	gen high_edu_6=1 if (asis_edu_6==1 & e53_2==1)
	gen high_edu_5=1 if high_edu_6==. & ((asis_edu_5==1 & e53_2==1) | (asis_edu_6==1 & e53_2!=1))
	gen high_edu_4=1 if high_edu_6==. & high_edu_5==. & ((asis_edu_4==1 & e53_2==1) | (asis_edu_5==1 & e53_2!=1) | (asis_edu_6==1 & e53_2!=1))
	gen high_edu_3=1 if high_edu_6==. & high_edu_5==. & high_edu_4==. & ((asis_edu_3==1 & e53_2==1) | (asis_edu_4==1 & e53_2!=1) | (asis_edu_5==1 & e53_2!=1) | (asis_edu_6==1 & e53_2!=1))
	gen high_edu_2=1 if high_edu_6==. & high_edu_5==. & high_edu_4==. & high_edu_3==. & ((asis_edu_2==1 & e53_2==1) | (asis_edu_3==1 & e53_2!=1) | (asis_edu_4==1 & e53_2!=1) | (asis_edu_5==1 & e53_2!=1) | (asis_edu_6==1 & e53_2!=1))
	gen high_edu_1=1 if high_edu_6==. & high_edu_5==. & high_edu_4==. & high_edu_3==. & high_edu_2==. & ((asis_edu_1==1 & e53_2==1) | (asis_edu_2==1 & e53_2!=1) | (asis_edu_3==1 & e53_2!=1) | (asis_edu_4==1 & e53_2!=1) | (asis_edu_5==1 & e53_2!=1) | (asis_edu_6==1 & e53_2!=1))
	gen high_edu_0=1 if high_edu_6==. & high_edu_5==. & high_edu_4==. & high_edu_3==. & high_edu_2==. & high_edu_1==. & ((asis_edu_0==1 & e53_2==1) | (asis_edu_1==1 & e53_2!=1) | (asis_edu_2==1 & e53_2!=1) | (asis_edu_3==1 & e53_2!=1) | (asis_edu_4==1 & e53_2!=1) | (asis_edu_5==1 & e53_2!=1) | (asis_edu_6==1 & e53_2!=1))
...
/*	
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if e40==4                                    // Single
		replace ilo_mrts_details=2 if e39==1                                    // Married
		replace ilo_mrts_details=3 if e39==2                                    // Union / cohabiting
		replace ilo_mrts_details=4 if e40==3                                    // Widowed
		replace ilo_mrts_details=5 if inlist(e40,1,2)| e40==5                   // Divorced / separated
	...
	* 1) UNIT OF PRODUCTION: FORMAL/INFORMAL SECTOR		
			...
			gen ilo_job1_ife_prod=.
				...
				replace ilo_job1_ife_prod=2 if ilo_lfs==1 & ilo_job1_ife_prod!=3 & ///
											   ...
											   (f75!=2 & ilo_job1_ste_aggregate==1 & f85!=1 & f81==1 & inlist(f80,3,4,5,6,7)) | ///
											   (f75!=2 & ilo_job1_ste_aggregate!=1 & f81==1 & inlist(f80,3,4,5,6,7)))
...
* Comment:
	...
	* 2) Weekly hours USUALLY worked:
	gen ilo_job1_how_usual = .
	    replace ilo_job1_how_usual = f88_1  if ilo_lfs==1
...
* Comment: 
		...
		gen ilo_olf_reason=.
			...
			*replace ilo_olf_reason=2 if                                        // Other labour market reasons
			replace ilo_olf_reason=3 if	inlist(f111,1,6) & ilo_lfs==3    	    // Personal/Family-related
