...
*            educational attendance or its finalization are used.
	...
	gen ilo_edu_attendance=.
	    replace ilo_edu_attendance=1 if e193==1		                            // Attending: EducaciÃ³n preescolar
		replace ilo_edu_attendance=1 if e197==1		                            // Attending: EducaciÃ³n primaria
		replace ilo_edu_attendance=1 if e201==1		                            // Attending: EducaciÃ³n media
		...
		replace ilo_edu_attendance=1 if e212==1		                            // Attending: Esenanza tÃ©cnica
...
/*	
	* Detailed
	gen ilo_mrts_details=.
	    replace ilo_mrts_details=1 if e36==5                                    // Single
		replace ilo_mrts_details=2 if e35==1                                    // Married
		replace ilo_mrts_details=3 if e35==2                                    // Union / cohabiting
		replace ilo_mrts_details=4 if e36==4                                    // Widowed
