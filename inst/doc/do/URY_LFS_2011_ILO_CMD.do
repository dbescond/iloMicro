* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Uruguay, 2011
* DATASET USED: Uruguay LFS 2011
* NOTES: 
* Files created: Standard variables on LFS Uruguay 2011
...
global source "LFS"
global time "2011"
global inputFile "Personas_2011_TERCEROS"
...
* Comment: - National classification is based on ISIC Rev.4 (4 digit-level available).
  ...
  * ISIC Rev. 4 - 2 digit-level
  destring f72_ciiu4_4, replace 
  
  gen ilo_job1_eco_isic4_2digits = int(f72_ciiu4_4/100) if ilo_lfs==1
  ...
  * SECOND JOB:
  * ISIC Rev. 4 - 2 digit-level
  destring f91_ciiu4_4, replace 
  
  gen ilo_job2_eco_isic4_2digits = int(f91_ciiu4_4/100) if ilo_mjh==2
...
* Comment: - National classification is based on ISCO-08 (4 digit-level available).
    ...
    * ISCO-08 2 digits-level
    destring f71_ciuo_08_4, replace
   
    gen ilo_job1_ocu_isco08_2digits = int(f71_ciuo_08_4/100) if ilo_lfs==1
    ...
    * SECOND JOB	   
    * ISCO-08 2 digits-level
    destring f90_ciuo_08_4, replace
   
    gen ilo_job2_ocu_isco08_2digits = int(f90_ciuo_08_4/100) if ilo_lfs==1
...
/*	Useful questions:
			...
			- Households identification: ilo_job1_eco_isic4_2digits==97 / ilo_job1_ocu_isco08_2digits==63
...
* Comment: - National classification is based on ISIC Rev.4 (4 digit-level are available).
  ...
  * ISIC Rev. 4 - 2 digit-level
  destring f120_ciiu4_4, replace 
  
  gen ilo_preveco_isic4_2digits = int(f120_ciiu4_4/100) if ilo_lfs==2 & ilo_cat_une==1
...
* Comment: - National classification is based on ISCO-08 (4 digit-level available).
    ...
    * MAIN JOB	   
    * ISCO-08 2 digits-level
    destring f119_ciuo_08_4, replace
   
    gen ilo_prevocu_isco08_2digits = int(f119_ciuo_08_4/100) if ilo_lfs==2 & ilo_cat_une==1
