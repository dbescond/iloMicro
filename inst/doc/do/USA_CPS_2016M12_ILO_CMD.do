...
* DATASET USED: USA CPS from http://thedataweb.rm.census.gov/ftp/cps_ftp.html
* NOTES:
...
global source "CPS"
global time "2016M12"
global inputFile "${country}_LFS_${time}"
...
gen isic_ilo = PEIO1ICD if ilo_lfs==1	
	destring isic_ilo, replace
	replace isic_ilo = int(isic_ilo/10)
...
replace ilo_job1_eco_isic4_2digits =10 if inlist(isic_ilo, 111, 311)
replace ilo_job1_eco_isic4_2digits =11 if inlist(isic_ilo, 111, 311, 312)
replace ilo_job1_eco_isic4_2digits =12 if inlist(isic_ilo, 111, 312)
replace ilo_job1_eco_isic4_2digits =13 if inlist(isic_ilo, 111, 313, 314, 315, 322, 323, 335, 336, 337, 339, 561)
replace ilo_job1_eco_isic4_2digits =14 if inlist(isic_ilo, 112, 313, 314, 315, 316, 339)
replace ilo_job1_eco_isic4_2digits =15 if inlist(isic_ilo, 111, 112, 314, 316, 339)
replace ilo_job1_eco_isic4_2digits =16 if inlist(isic_ilo, 113, 115, 321, 324, 337, 339)
replace ilo_job1_eco_isic4_2digits =17 if inlist(isic_ilo, 114, 322, 323, 332, 339)
replace ilo_job1_eco_isic4_2digits =18 if inlist(isic_ilo, 323, 334, 339)
replace ilo_job1_eco_isic4_2digits =19 if inlist(isic_ilo, 324, 325)
replace ilo_job1_eco_isic4_2digits =20 if inlist(isic_ilo, 312, 325, 332, 339)
replace ilo_job1_eco_isic4_2digits =21 if inlist(isic_ilo, 113, 325, 339)
replace ilo_job1_eco_isic4_2digits =22 if inlist(isic_ilo, 113, 313, 314, 315, 321, 322, 325, 326, 332, 336, 337, 339)
replace ilo_job1_eco_isic4_2digits =23 if inlist(isic_ilo, 111, 113, 322, 324, 325, 327, 335, 336, 339, 453)
replace ilo_job1_eco_isic4_2digits =24 if inlist(isic_ilo, 113, 115, 322, 331, 332)
replace ilo_job1_eco_isic4_2digits =25 if inlist(isic_ilo, 322, 323, 331, 332, 333, 336, 337, 339)
replace ilo_job1_eco_isic4_2digits =26 if inlist(isic_ilo, 333, 334, 339)
replace ilo_job1_eco_isic4_2digits =27 if inlist(isic_ilo, 326, 331, 332, 333, 334, 335, 336, 339)
replace ilo_job1_eco_isic4_2digits =28 if inlist(isic_ilo, 325, 331, 332, 333, 336, 339)
replace ilo_job1_eco_isic4_2digits =29 if inlist(isic_ilo, 326, 332, 333, 336, 811)
replace ilo_job1_eco_isic4_2digits =30 if inlist(isic_ilo, 331, 332, 333, 334, 336, 339)
replace ilo_job1_eco_isic4_2digits =31 if inlist(isic_ilo, 114, 311, 321, 326, 337)
replace ilo_job1_eco_isic4_2digits =32 if inlist(isic_ilo, 111, 112, 327, 332, 333, 337, 339, 711)
replace ilo_job1_eco_isic4_2digits =33 if inlist(isic_ilo, 238, 336, 441, 443, 488, 711, 811)
replace ilo_job1_eco_isic4_2digits =35 if inlist(isic_ilo, 221, 312)
replace ilo_job1_eco_isic4_2digits =36 if inlist(isic_ilo, 221)
replace ilo_job1_eco_isic4_2digits =37 if inlist(isic_ilo, 221, 562)
replace ilo_job1_eco_isic4_2digits =38 if inlist(isic_ilo, 488, 562)
replace ilo_job1_eco_isic4_2digits =39 if inlist(isic_ilo, 562)
replace ilo_job1_eco_isic4_2digits =41 if inlist(isic_ilo, 236)
replace ilo_job1_eco_isic4_2digits =42 if inlist(isic_ilo, 236, 237, 238)
replace ilo_job1_eco_isic4_2digits =43 if inlist(isic_ilo, 213, 236, 237, 238, 561)
replace ilo_job1_eco_isic4_2digits =45 if inlist(isic_ilo, 423, 425, 441, 452, 811)
replace ilo_job1_eco_isic4_2digits =46 if inlist(isic_ilo, 423, 424, 425)
replace ilo_job1_eco_isic4_2digits =47 if inlist(isic_ilo, 441, 442, 443, 444, 445, 446, 447, 448, 451, 452, 453, 454)
replace ilo_job1_eco_isic4_2digits =49 if inlist(isic_ilo, 221, 482, 484, 485, 486, 487, 713)
replace ilo_job1_eco_isic4_2digits =50 if inlist(isic_ilo, 483, 487)
replace ilo_job1_eco_isic4_2digits =51 if inlist(isic_ilo, 211, 212, 481, 487, 927)
replace ilo_job1_eco_isic4_2digits =52 if inlist(isic_ilo, 212, 488, 493, 812)
replace ilo_job1_eco_isic4_2digits =53 if inlist(isic_ilo, 491, 492)
replace ilo_job1_eco_isic4_2digits =55 if inlist(isic_ilo, 721)
replace ilo_job1_eco_isic4_2digits =56 if inlist(isic_ilo, 722)
replace ilo_job1_eco_isic4_2digits =58 if inlist(isic_ilo, 511, 519)
replace ilo_job1_eco_isic4_2digits =59 if inlist(isic_ilo, 512, 519)
replace ilo_job1_eco_isic4_2digits =60 if inlist(isic_ilo, 515, 519)
replace ilo_job1_eco_isic4_2digits =61 if inlist(isic_ilo, 211, 515, 517, 812)
replace ilo_job1_eco_isic4_2digits =62 if inlist(isic_ilo, 211, 541)
replace ilo_job1_eco_isic4_2digits =63 if inlist(isic_ilo, 518, 519)
replace ilo_job1_eco_isic4_2digits =64 if inlist(isic_ilo, 521, 522, 523, 525, 551)
replace ilo_job1_eco_isic4_2digits =65 if inlist(isic_ilo, 524, 525)
replace ilo_job1_eco_isic4_2digits =66 if inlist(isic_ilo, 522, 523, 524, 541)
replace ilo_job1_eco_isic4_2digits =68 if inlist(isic_ilo, 523, 531)
replace ilo_job1_eco_isic4_2digits =69 if inlist(isic_ilo, 541)
replace ilo_job1_eco_isic4_2digits =70 if inlist(isic_ilo, 541, 551)
replace ilo_job1_eco_isic4_2digits =71 if inlist(isic_ilo, 212, 541, 811)
replace ilo_job1_eco_isic4_2digits =72 if inlist(isic_ilo, 212, 541)
replace ilo_job1_eco_isic4_2digits =73 if inlist(isic_ilo, 541)
replace ilo_job1_eco_isic4_2digits =74 if inlist(isic_ilo, 518, 541, 711, 812)
replace ilo_job1_eco_isic4_2digits =75 if inlist(isic_ilo, 115, 541)
replace ilo_job1_eco_isic4_2digits =77 if inlist(isic_ilo, 532, 533)
replace ilo_job1_eco_isic4_2digits =78 if inlist(isic_ilo, 561)
replace ilo_job1_eco_isic4_2digits =79 if inlist(isic_ilo, 561, 713, 926)
replace ilo_job1_eco_isic4_2digits =80 if inlist(isic_ilo, 541, 561)
replace ilo_job1_eco_isic4_2digits =81 if inlist(isic_ilo, 212, 238, 488, 561, 811)
replace ilo_job1_eco_isic4_2digits =82 if inlist(isic_ilo, 323, 325, 561)
replace ilo_job1_eco_isic4_2digits =84 if inlist(isic_ilo, 561, 921, 922, 923, 924, 925, 926, 927, 928)
replace ilo_job1_eco_isic4_2digits =85 if inlist(isic_ilo, 611)
replace ilo_job1_eco_isic4_2digits =86 if inlist(isic_ilo, 621, 622)
replace ilo_job1_eco_isic4_2digits =87 if inlist(isic_ilo, 623)
replace ilo_job1_eco_isic4_2digits =88 if inlist(isic_ilo, 541, 621, 624)
replace ilo_job1_eco_isic4_2digits =89 if inlist(isic_ilo, 212, 311)
replace ilo_job1_eco_isic4_2digits =90 if inlist(isic_ilo, 711)
replace ilo_job1_eco_isic4_2digits =91 if inlist(isic_ilo, 213, 488, 519, 712)
replace ilo_job1_eco_isic4_2digits =92 if inlist(isic_ilo, 713, 721)
replace ilo_job1_eco_isic4_2digits =93 if inlist(isic_ilo, 711, 713, 813)
replace ilo_job1_eco_isic4_2digits =94 if inlist(isic_ilo, 813)
replace ilo_job1_eco_isic4_2digits =95 if inlist(isic_ilo, 442, 443, 444, 448, 451, 811, 812)
replace ilo_job1_eco_isic4_2digits =96 if inlist(isic_ilo, 561, 812)
replace ilo_job1_eco_isic4_2digits =97 if inlist(isic_ilo, 814)
replace ilo_job1_eco_isic4_2digits =99 if inlist(isic_ilo, 213, 928)
