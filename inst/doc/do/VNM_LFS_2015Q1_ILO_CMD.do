* TITLE OF DO FILE: ILO Microdata Preprocessing code template - Vietnam, 1st Quarter 2015
* DATASET USED: Vietnam LFS 1st Quarter 2015
* NOTES: 
* Files created: Standard variables on LFS Vietnam 1st Quarter 2015 
* Authors: Marylène Escher
* Who last updated the file: Marylène Escher
* Starting Date: 7 October 2016
...
global inpath "I:\COMMON\A6 Microdatasets\VNM\LFS\2015Q1\ORI"
global outpath "I:\COMMON\A6 Microdatasets\VNM\LFS\2015Q1"
...
cd "$inpath"
	...
	use "quy_1_2015_final_eng", clear	
...
/* Among the people TEMPORARY ABSENT from work, only those who are either PAID during the absence or 
   those who will return to work in less than ONE MONTH are counted as employed.  */
...
* -------------------------------------------------------------------------------------------
	...
	/* At a 2 digit-level the national classification is identic to ISIC Rev. 4	 */
...
* -------------------------------------------------------------------------------------------			
	...
	/* NOTES:
	   ...
	   * It includes overtime remunerations, bonuses, occupational allowances and other welfare payments.
...
* -------------------------------------------------------------------------------------------
	...
	/* Here are the possible answers to question 54: " How long have you been looking for job?"
				1. Under 1 month
...
* -------------------------------------------------------------------------------------------		
		...
		gen ilo_olf_reason=.
			...
			replace ilo_olf_reason=4 if inlist(c55,-1,13,.) & ilo_lfs==3		//Not elsewhere classified
...
* 1 - Full dataset with original variables and ILO ones
	...
	cd "$outpath"
        ...
        compress
		saveold VNM_LFS_2015Q1_FULL, version(12) replace
...
* 2 - Dataset with only 'ILO' variables
		...
		keep ilo*
		saveold VNM_LFS_2015Q1_ILO, version(12) replace
