...
* DATASET USED: VIET NAM, SWTS, 2013
* NOTES: 
* Files created: Standard variables VNM_SWTS_2013_FULL.dta and VNM_SWTS_2013_ILO.dta
...
global country "VNM" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2013"  /*time*/
global inputFile "VNM_SWTS_2012.dta" /*name of the input file in stata format*/
...
* Comment:
	...
	* Detailed
	gen ilo_edu_isced97=.
		replace ilo_edu_isced97=1 if highestlevel_comp1 ==1  | currently_attend==4    // No schooling
		replace ilo_edu_isced97=2 if  highestlevel_comp1 ==2      // Pre-primary education
		replace ilo_edu_isced97=3 if highestlevel_comp1 ==3      // Primary education or first stage of basic education
		replace ilo_edu_isced97=4 if   highestlevel_comp1 ==4     // Lower secondary education or second stage of basic education
		replace ilo_edu_isced97=5 if    highestlevel_comp1 ==5    // Upper secondary education
		replace ilo_edu_isced97=6 if   highestlevel_comp1 ==6    // Post-secondary non-tertiary education
		replace ilo_edu_isced97=7 if   highestlevel_comp1 ==7     // First stage of tertiary education (not leading directly to an advanced research qualification)
		replace ilo_edu_isced97=8 if  highestlevel_comp1 ==8      // Second stage of tertiary education (leading to an advanced research qualification)                               
