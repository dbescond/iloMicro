* TITLE OF DO FILE: ILO Microdata Preprocessing code template - ZAMBIA, 2012
* DATASET USED: ZAMBIA, SWTS, 2012
* NOTES: 
* Files created: Standard variables ZMB_SWTS_2012_FULL.dta and ZMB_SWTS_2012_ILO.dta
...
global country "ZMB" /*ref_area: ISO 3 Code from the workflow*/
global source "SWTS"  /*survey: Acronym from the workflow*/
global time "2012"  /*time*/
global inputFile "ZMB_SWTS_2012.dta" /*name of the input file in stata format*/
...
* Comment: 
	...
	gen ilo_geo=.
	    replace ilo_geo=1 if setting==2         // Urban 
		replace ilo_geo=2 if setting==1         // Rural
...
* Comment: 
	...
	* Detailed
	gen ilo_mrts_details=.
		...
		replace ilo_mrts_details=3 if   b10==2                                        // Union / cohabiting
...
* Comment: 
    ...
    * Detailed
       gen ilo_dsb_details=.
             replace ilo_dsb_details=1 if (b18==1 & b19==1 & b20==1 & b21==1 & b22==1 & b23==1)                            
             replace ilo_dsb_details=2 if (b18==2 | b19==2 | b20==2 | b21==2 | b22==2 | b23==2 )                                                 
             replace ilo_dsb_details=3 if (b18==3 | b19==3 | b20==3 | b21==3 | b22==3 | b23==3 )                                                 
             replace ilo_dsb_details=4 if (b18==4 | b19==4 | b20==4 | b21==4 | b22==4 | b23==4)
...
* Comment: 
	...
	gen ilo_lfs=.
        replace ilo_lfs=1 if (c38a==1 | c38b==1 | c38c==1 | c38d==1 | ///
		c38e==1 | c38f==1 | c38g==1 ) & ilo_wap==1				   				// Employed: ILO definition
		replace ilo_lfs=1 if c39==1 & !inlist(c40,13) & ilo_wap==1			// Employed: temporary absent
...
* Comment: 
	...
	* 2-digit level
	gen ilo_job1_eco_isic4_2digits = . 
	    replace ilo_job1_eco_isic4_2digits = d4_code     if ilo_lfs==1
...
* Comment:
	...
	* 2-digit level 
    gen ilo_job1_ocu_isco08_2digits = . 
	    replace ilo_job1_ocu_isco08_2digits = d2_code    if ilo_lfs==1
		replace ilo_job1_ocu_isco08_2digits=2 if d2_code ==102 & ilo_lfs==1
		replace ilo_job1_ocu_isco08_2digits=1 if d2_code ==103 & ilo_lfs==1
...
* Comment: 
	...
	* Hours ACTUALLY worked
	gen ilo_job1_how_actual = .
	    replace ilo_job1_how_actual = d33      if ilo_lfs==1 & d33<160
...
* Comment: 
	...
	* Employees
	gen ilo_job1_lri_ees = .
	    replace ilo_job1_lri_ees = d14_amount if ilo_job1_ste_aggregate==1 & d14_amount>0
	...
	* Self-employed
	gen ilo_job1_lri_slf = .
		...
		replace ilo_job1_lri_slf=ilo_job1_lri_slf + d29 if d28==1 & d29>0
...
* Comment: 
	...
	* Detailed categories		
    gen ilo_dur_details=.
		...
		replace ilo_dur_details=2 if e12==3      & ilo_lfs==2                 // 1 to 3 months *[C7:3905]
...
* Comment: 
		...
		gen ilo_olf_reason=.
			...
			replace ilo_olf_reason=5 if (inlist(e5,99) | ilo_olf_reason==.) & ilo_lfs==3     	// Not elsewhere classified
