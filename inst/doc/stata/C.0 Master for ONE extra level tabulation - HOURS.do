...
preserve
	...
	collapse(sum) ilo_wgt sample_count total_hours if condition==1, by(ilo_time ilo_sex $LEVEL1)
...
preserve
	gen sample_count=1 //This variable will helps us count the number of observations for each tabulation.
	gen total_hours = ilo_wgt * $hours
	collapse(sum) ilo_wgt sample_count total_hours if condition==1, by(ilo_time $LEVEL1)
	gen value = total_hours / ilo_wgt
	rename ilo_time time
