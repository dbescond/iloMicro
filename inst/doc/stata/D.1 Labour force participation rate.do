...
A) Labour force participation rate by sex and age:
	A.1. AGE_AGGREGATE
	A.2. AGE_10YRBANDS
	A.3. AGE_5YRBANDS

B) Labour force participation rate by sex and education:
	B.1. EDU_ISCED11
	B.1. EDU_ISCED97
	B.1. EDU_AGGREGATE
		
C) Labour force participation rate by sex, age and rural / urban areas:
...
********************************************************************************************
*** A) Labour force participation rate by sex and age **************************************
*** This indicator is calculated as: EAP_TEAP_NB / POP_XWAP_NB * 100
global indicator   = "EAP_DWAP_SEX_AGE_RT"
global numerator   = "EAP_TEAP_SEX_AGE_NB"
...
*** B) Labour force participation rate by sex and education ********************************
*** This indicator is calculated as: EAP_TEAP_NB / POP_XWAP_NB * 100
global indicator   = "EAP_DWAP_SEX_EDU_RT"
global numerator   = "EAP_TEAP_SEX_EDU_NB"
...
*** C) Labour force participation rate by sex, age and rural / urban areas *****************
*** This indicator is calculated as: EAP_TEAP_NB / POP_XWAP_NB * 100
global indicator   = "EAP_DWAP_SEX_AGE_GEO_RT"
global numerator   = "EAP_TEAP_SEX_AGE_GEO_NB"
