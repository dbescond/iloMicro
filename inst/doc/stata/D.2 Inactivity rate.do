...
A) Inactivity rate by sex and age:
	A.1. AGE_AGGREGATE
	A.2. AGE_10YRBANDS
	A.3. AGE_5YRBANDS
*/
...
********************************************************************************************
*** A) Inactivity rate by sex and age ******************************************************
*** This indicator is calculated as:  EIP_TEIP_NB / POP_XWAP * 100
global indicator   = "EIP_DWAP_SEX_AGE_RT"
global numerator   = "EIP_TEIP_SEX_AGE_NB"
