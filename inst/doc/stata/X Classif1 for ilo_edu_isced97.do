...
*This do-file generates the column classif1 for edu_isced97 [Level of education (ISCED 97)]
...
gen     classif1 = ""
replace classif1 = "EDU_ISCED97_X"   if ilo_edu_isced97==1
replace classif1 = "EDU_ISCED97_0"   if ilo_edu_isced97==2
replace classif1 = "EDU_ISCED97_1"   if ilo_edu_isced97==3
replace classif1 = "EDU_ISCED97_2"   if ilo_edu_isced97==4
replace classif1 = "EDU_ISCED97_3"   if ilo_edu_isced97==5
replace classif1 = "EDU_ISCED97_4"   if ilo_edu_isced97==6
replace classif1 = "EDU_ISCED97_5"   if ilo_edu_isced97==7
replace classif1 = "EDU_ISCED97_6"   if ilo_edu_isced97==8
replace classif1 = "EDU_ISCED97_UNK" if ilo_edu_isced97==9
