...
*This do-file generates the column classif1 for ilo_olf_dlma [Labour market attachment (Degree of)]
...
*/
gen     classif1 = ""
replace classif1 = "OLF_DLMA_UJS"   if ilo_olf_dlma==1
replace classif1 = "OLF_DLMA_DSC"   if ilo_olf_dlma==2
replace classif1 = "OLF_DLMA_WNJS"  if ilo_olf_dlma==3
replace classif1 = "OLF_DLMA_NWNJS" if ilo_olf_dlma==4
