...
*This do-file generates the column classif1 for ilo_preveco_isic3 [Previous economic activity (ISIC Rev. 3.1)]
...
gen     classif1 = ""
replace classif1 = "ECO_ISIC3_A"   if ilo_preveco_isic3==1
replace classif1 = "ECO_ISIC3_B"   if ilo_preveco_isic3==2
replace classif1 = "ECO_ISIC3_C"   if ilo_preveco_isic3==3
replace classif1 = "ECO_ISIC3_D"   if ilo_preveco_isic3==4
replace classif1 = "ECO_ISIC3_E"   if ilo_preveco_isic3==5
replace classif1 = "ECO_ISIC3_F"   if ilo_preveco_isic3==6
replace classif1 = "ECO_ISIC3_G"   if ilo_preveco_isic3==7
replace classif1 = "ECO_ISIC3_H"   if ilo_preveco_isic3==8
replace classif1 = "ECO_ISIC3_I"   if ilo_preveco_isic3==9
replace classif1 = "ECO_ISIC3_J"   if ilo_preveco_isic3==10
replace classif1 = "ECO_ISIC3_K"   if ilo_preveco_isic3==11
replace classif1 = "ECO_ISIC3_L"   if ilo_preveco_isic3==12
replace classif1 = "ECO_ISIC3_M"   if ilo_preveco_isic3==13
replace classif1 = "ECO_ISIC3_N"   if ilo_preveco_isic3==14
replace classif1 = "ECO_ISIC3_O"   if ilo_preveco_isic3==15
replace classif1 = "ECO_ISIC3_P"   if ilo_preveco_isic3==16
replace classif1 = "ECO_ISIC3_Q"   if ilo_preveco_isic3==17
replace classif1 = "ECO_ISIC3_X"   if ilo_preveco_isic3==18
