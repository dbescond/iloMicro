...
*This do-file generates the column classif1 for ilo_preveco_isic4 [Previous economic activity (ISIC Rev. 4)]
...
gen     classif1 = ""
replace classif1 = "ECO_ISIC4_A"   if ilo_preveco_isic4==1
replace classif1 = "ECO_ISIC4_B"   if ilo_preveco_isic4==2
replace classif1 = "ECO_ISIC4_C"   if ilo_preveco_isic4==3
replace classif1 = "ECO_ISIC4_D"   if ilo_preveco_isic4==4
replace classif1 = "ECO_ISIC4_E"   if ilo_preveco_isic4==5
replace classif1 = "ECO_ISIC4_F"   if ilo_preveco_isic4==6
replace classif1 = "ECO_ISIC4_G"   if ilo_preveco_isic4==7
replace classif1 = "ECO_ISIC4_H"   if ilo_preveco_isic4==8
replace classif1 = "ECO_ISIC4_I"   if ilo_preveco_isic4==9
replace classif1 = "ECO_ISIC4_J"   if ilo_preveco_isic4==10
replace classif1 = "ECO_ISIC4_K"   if ilo_preveco_isic4==11
replace classif1 = "ECO_ISIC4_L"   if ilo_preveco_isic4==12
replace classif1 = "ECO_ISIC4_M"   if ilo_preveco_isic4==13
replace classif1 = "ECO_ISIC4_N"   if ilo_preveco_isic4==14
replace classif1 = "ECO_ISIC4_O"   if ilo_preveco_isic4==15
replace classif1 = "ECO_ISIC4_P"   if ilo_preveco_isic4==16
replace classif1 = "ECO_ISIC4_Q"   if ilo_preveco_isic4==17
replace classif1 = "ECO_ISIC4_R"   if ilo_preveco_isic4==18
replace classif1 = "ECO_ISIC4_S"   if ilo_preveco_isic4==19
replace classif1 = "ECO_ISIC4_T"   if ilo_preveco_isic4==20
replace classif1 = "ECO_ISIC4_U"   if ilo_preveco_isic4==21
replace classif1 = "ECO_ISIC4_X"   if ilo_preveco_isic4==22
